...
>[!INFO]
>
>このオプションは、[&#128279;](https://experienceleague.adobe.com/docs/commerce-admin/inventory/guide-overview.html)Inventory management[ と組み合わせて ](high-throughput-order-processing.md#asynchronous-order-placement) 非同期注文プレースメント  でも機能します。
