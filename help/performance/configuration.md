...
>[!INFO]
>
>このオプションは、[Inventory management](high-throughput-order-processing.md#asynchronous-order-placement)と組み合わせて[非同期注文処理](https://experienceleague.adobe.com/docs/commerce-admin/inventory/guide-overview.html?lang=ja)でも使用できます。
