...
>[!NOTE]
>
>ActiveMQ Artemis は、Adobe Commerce 2.4.6 以降のバージョンで導入されました。 クラウドインフラストラクチャプロジェクトのAdobe CommerceCommerceへの ActiveMQ Artemis のインストールについて詳しくは、[Cloud Guide の ](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/configure/service/activemq)ActiveMQ サービスの設定 *を参照してください*
