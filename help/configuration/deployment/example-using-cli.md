...
これは、共有設定の組み合わせ ( `config.php` ファイル、および Commerce CLI コマンドを使用します。
...
- **デフォルトの電子メールドメイン** を設定します。
  ...
  これは、の下にあります。 **ストア** /設定/ **設定** /お客様 > **顧客設定** > **新しいアカウントオプションの作成**.
...
- 各設定の範囲
  ...
  手順 1 の手順に従った場合は、 **メール送信先** は Web サイトであり、 **デフォルトの電子メールドメイン** はグローバル（デフォルトの設定範囲）です。
