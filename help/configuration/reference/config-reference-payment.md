...
これらのオプションは、で英国を選択した場合にのみ使用できます [商国](../reference/config-reference-sens.md#payment-sensitive-and-system-specific-paths).
...
>[!INFO]
>
>使用可能なパスは、次のいずれかを選択して決定します [商社国](../reference/config-reference-sens.md#payment-sensitive-and-system-specific-paths).
...
| Enabled | `payment_nz/cybersource/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_nz/cybersource/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_nz/cybersource/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 新規注文ステータス | `payment_nz/cybersource/order_status` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_nz/cybersource/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_nz/cybersource/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_nz/cybersource/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_nz/cybersource/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最小注文合計 | `payment_nz/cybersource/min_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最大注文合計 | `payment_nz/cybersource/max_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_nz/cybersource/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_nz/worldpay/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_nz/worldpay/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報の編集を許可 | `payment_nz/worldpay/fix_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報を非表示 | `payment_nz/worldpay/hide_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 署名フィールド | `payment_nz/worldpay/signature_fields` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_nz/worldpay/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| テストの支払アクション | `payment_nz/worldpay/test_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_nz/worldpay/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_nz/worldpay/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_nz/worldpay/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 注文ステータスを「Suspected Fraud for CVV」に設定 | `payment_nz/worldpay/cvv_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 郵便番号 AVS の注文ステータスを不正疑いに設定 | `payment_nz/worldpay/avs_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_nz/worldpay/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_nz/eway/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 接続タイプ | `payment_nz/eway/connection_type` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_nz/eway/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_nz/eway/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_nz/eway/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_nz/eway/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_nz/eway/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_nz/eway/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_nz/eway/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| Enabled | `payment_hk/cybersource/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_hk/cybersource/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_hk/cybersource/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 新規注文ステータス | `payment_hk/cybersource/order_status` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_hk/cybersource/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_hk/cybersource/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_hk/cybersource/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_hk/cybersource/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最小注文合計 | `payment_hk/cybersource/min_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最大注文合計 | `payment_hk/cybersource/max_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_hk/cybersource/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_hk/worldpay/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_hk/worldpay/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報の編集を許可 | `payment_hk/worldpay/fix_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報を非表示 | `payment_hk/worldpay/hide_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_hk/worldpay/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| テストの支払アクション | `payment_hk/worldpay/test_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_hk/worldpay/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_hk/worldpay/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_hk/worldpay/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 注文ステータスを「Suspected Fraud for CVV」に設定 | `payment_hk/worldpay/cvv_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 郵便番号 AVS の注文ステータスを不正疑いに設定 | `payment_hk/worldpay/avs_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_hk/worldpay/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_hk/eway/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 接続タイプ | `payment_hk/eway/connection_type` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_hk/eway/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| サンドボックスモード | `payment_hk/eway/sandbox_flag` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_hk/eway/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_hk/eway/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_hk/eway/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_hk/eway/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_hk/eway/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_hk/eway/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| Enabled | `payment_es/cybersource/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_es/cybersource/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_es/cybersource/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| プロファイル ID | `payment_es/cybersource/profile_id` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) | ![暗号化](/help/assets/configuration/cloud-enc.png) |
| 新規注文ステータス | `payment_es/cybersource/order_status` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_es/cybersource/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_es/cybersource/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_es/cybersource/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_es/cybersource/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最小注文合計 | `payment_es/cybersource/min_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最大注文合計 | `payment_es/cybersource/max_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_es/cybersource/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_es/worldpay/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_es/worldpay/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| インストール ID | `payment_es/worldpay/installation_id` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| リモート管理者インストール ID | `payment_es/worldpay/admin_installation_id` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報の編集を許可 | `payment_es/worldpay/fix_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報を非表示 | `payment_es/worldpay/hide_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 署名フィールド | `payment_es/worldpay/signature_fields` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| テストモード | `payment_es/worldpay/sandbox_flag` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| テストの支払アクション | `payment_es/worldpay/test_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_es/worldpay/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_es/worldpay/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_es/worldpay/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 注文ステータスを「Suspected Fraud for CVV」に設定 | `payment_es/worldpay/cvv_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 郵便番号 AVS の注文ステータスを不正疑いに設定 | `payment_es/worldpay/avs_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_es/worldpay/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_es/eway/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 接続タイプ | `payment_es/eway/connection_type` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_es/eway/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_es/eway/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_es/eway/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_es/eway/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_es/eway/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_es/eway/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_es/eway/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| Enabled | `payment_it/cybersource/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_it/cybersource/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_it/cybersource/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 新規注文ステータス | `payment_it/cybersource/order_status` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_it/cybersource/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_it/cybersource/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_it/cybersource/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_it/cybersource/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最小注文合計 | `payment_it/cybersource/min_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最大注文合計 | `payment_it/cybersource/max_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_it/cybersource/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_it/worldpay/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_it/worldpay/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報の編集を許可 | `payment_it/worldpay/fix_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報を非表示 | `payment_it/worldpay/hide_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 署名フィールド | `payment_it/worldpay/signature_fields` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_it/worldpay/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| テストの支払アクション | `payment_it/worldpay/test_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_it/worldpay/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_it/worldpay/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_it/worldpay/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 注文ステータスを「Suspected Fraud for CVV」に設定 | `payment_it/worldpay/cvv_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 郵便番号 AVS の注文ステータスを不正疑いに設定 | `payment_it/worldpay/avs_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_it/worldpay/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_it/eway/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 接続タイプ | `payment_it/eway/connection_type` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_it/eway/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_it/eway/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_it/eway/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_it/eway/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_it/eway/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_it/eway/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_it/eway/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| Enabled | `payment_fr/cybersource/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_fr/cybersource/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_fr/cybersource/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 新規注文ステータス | `payment_fr/cybersource/order_status` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_fr/cybersource/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_fr/cybersource/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_fr/cybersource/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_fr/cybersource/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最小注文合計 | `payment_fr/cybersource/min_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最大注文合計 | `payment_fr/cybersource/max_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_fr/cybersource/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_fr/worldpay/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_fr/worldpay/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報の編集を許可 | `payment_fr/worldpay/fix_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報を非表示 | `payment_fr/worldpay/hide_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_fr/worldpay/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| テストの支払アクション | `payment_fr/worldpay/test_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_fr/worldpay/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_fr/worldpay/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_fr/worldpay/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 注文ステータスを「Suspected Fraud for CVV」に設定 | `payment_fr/worldpay/cvv_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 郵便番号 AVS の注文ステータスを不正疑いに設定 | `payment_fr/worldpay/avs_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_fr/worldpay/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_fr/eway/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 接続タイプ | `payment_fr/eway/connection_type` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_fr/eway/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_fr/eway/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_fr/eway/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_fr/eway/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_fr/eway/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_fr/eway/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_fr/eway/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| Enabled | `payment_jp/cybersource/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_jp/cybersource/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_jp/cybersource/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_jp/cybersource/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_jp/cybersource/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_jp/cybersource/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_jp/cybersource/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最小注文合計 | `payment_jp/cybersource/min_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最大注文合計 | `payment_jp/cybersource/max_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_jp/cybersource/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_jp/worldpay/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_jp/worldpay/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報の編集を許可 | `payment_jp/worldpay/fix_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報を非表示 | `payment_jp/worldpay/hide_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_jp/worldpay/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| テストの支払アクション | `payment_jp/worldpay/test_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_jp/worldpay/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_jp/worldpay/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_jp/worldpay/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 注文ステータスを「Suspected Fraud for CVV」に設定 | `payment_jp/worldpay/cvv_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 郵便番号 AVS の注文ステータスを不正疑いに設定 | `payment_jp/worldpay/avs_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_jp/worldpay/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_jp/eway/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 接続タイプ | `payment_jp/eway/connection_type` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_jp/eway/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_jp/eway/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_jp/eway/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_jp/eway/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_jp/eway/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_jp/eway/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_jp/eway/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| Enabled | `payment_au/cybersource/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_au/cybersource/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_au/cybersource/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| マーチャント ID | `payment_au/cybersource/merchant_id` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) | ![暗号化](/help/assets/configuration/cloud-enc.png) |
| プロファイル ID | `payment_au/cybersource/profile_id` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) | ![暗号化](/help/assets/configuration/cloud-enc.png) |
| 新規注文ステータス | `payment_au/cybersource/order_status` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_au/cybersource/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_au/cybersource/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_au/cybersource/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_au/cybersource/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最小注文合計 | `payment_au/cybersource/min_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最大注文合計 | `payment_au/cybersource/max_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_au/cybersource/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_au/worldpay/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_au/worldpay/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| インストール ID | `payment_au/worldpay/installation_id` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報の編集を許可 | `payment_au/worldpay/fix_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報を非表示 | `payment_au/worldpay/hide_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 署名フィールド | `payment_au/worldpay/signature_fields` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_au/worldpay/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| テストモード | `payment_au/worldpay/sandbox_flag` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| テストの支払アクション | `payment_au/worldpay/test_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_au/worldpay/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_au/worldpay/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_au/worldpay/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 注文ステータスを「Suspected Fraud for CVV」に設定 | `payment_au/worldpay/cvv_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 郵便番号 AVS の注文ステータスを不正疑いに設定 | `payment_au/worldpay/avs_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_au/worldpay/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_au/eway/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 接続タイプ | `payment_au/eway/connection_type` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_au/eway/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_au/eway/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_au/eway/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_au/eway/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_au/eway/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_au/eway/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_au/eway/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| Enabled | `payment_ca/cybersource/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_ca/cybersource/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_ca/cybersource/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_ca/cybersource/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_ca/cybersource/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_ca/cybersource/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_ca/cybersource/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最小注文合計 | `payment_ca/cybersource/min_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最大注文合計 | `payment_ca/cybersource/max_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_ca/cybersource/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_ca/worldpay/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_ca/worldpay/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報の編集を許可 | `payment_ca/worldpay/fix_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報を非表示 | `payment_ca/worldpay/hide_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 署名フィールド | `payment_ca/worldpay/signature_fields` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_ca/worldpay/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| テストの支払アクション | `payment_ca/worldpay/test_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_ca/worldpay/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_ca/worldpay/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_ca/worldpay/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 注文ステータスを「Suspected Fraud for CVV」に設定 | `payment_ca/worldpay/cvv_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 郵便番号 AVS の注文ステータスを不正疑いに設定 | `payment_ca/worldpay/avs_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_ca/worldpay/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_ca/eway/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 接続タイプ | `payment_ca/eway/connection_type` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_ca/eway/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_ca/eway/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_ca/eway/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_ca/eway/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_ca/eway/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_ca/eway/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_ca/eway/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| Enabled | `payment_other/cybersource/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_other/cybersource/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_other/cybersource/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_other/cybersource/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_other/cybersource/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_other/cybersource/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_other/cybersource/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最小注文合計 | `payment_other/cybersource/min_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最大注文合計 | `payment_other/cybersource/max_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_other/cybersource/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_other/worldpay/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_other/worldpay/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報の編集を許可 | `payment_other/worldpay/fix_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報を非表示 | `payment_other/worldpay/hide_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 署名フィールド | `payment_other/worldpay/signature_fields` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_other/worldpay/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| テストの支払アクション | `payment_other/worldpay/test_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_other/worldpay/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_other/worldpay/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_other/worldpay/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 注文ステータスを「Suspected Fraud for CVV」に設定 | `payment_other/worldpay/cvv_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 郵便番号 AVS の注文ステータスを不正疑いに設定 | `payment_other/worldpay/avs_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_other/worldpay/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_other/eway/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 接続タイプ | `payment_other/eway/connection_type` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_other/eway/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_other/eway/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_other/eway/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_other/eway/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_other/eway/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_other/eway/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_other/eway/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| Enabled | `payment_de/cybersource/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_de/cybersource/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_de/cybersource/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 新規注文ステータス | `payment_de/cybersource/order_status` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_de/cybersource/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_de/cybersource/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_de/cybersource/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_de/cybersource/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最小注文合計 | `payment_de/cybersource/min_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最大注文合計 | `payment_de/cybersource/max_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_de/cybersource/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| Enabled | `payment_de/worldpay/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_de/worldpay/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報の編集を許可 | `payment_de/worldpay/fix_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報を非表示 | `payment_de/worldpay/hide_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 署名フィールド | `payment_de/worldpay/signature_fields` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| テストモード | `payment_de/worldpay/sandbox_flag` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| テストの支払アクション | `payment_de/worldpay/test_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_de/worldpay/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_de/worldpay/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_de/worldpay/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 注文ステータスを「Suspected Fraud for CVV」に設定 | `payment_de/worldpay/cvv_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 郵便番号 AVS の注文ステータスを不正疑いに設定 | `payment_de/worldpay/avs_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_de/worldpay/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_de/eway/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 接続タイプ | `payment_de/eway/connection_type` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_de/eway/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_de/eway/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_de/eway/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_de/eway/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_de/eway/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_de/eway/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_de/eway/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| Enabled | `payment_gb/cybersource/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_gb/cybersource/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_gb/cybersource/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 新規注文ステータス | `payment_gb/cybersource/order_status` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_gb/cybersource/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_gb/cybersource/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_gb/cybersource/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_gb/cybersource/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最小注文合計 | `payment_gb/cybersource/min_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最大注文合計 | `payment_gb/cybersource/max_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_gb/cybersource/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| Enabled | `payment_gb/worldpay/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_gb/worldpay/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| トランザクションの MD5 シークレット | `payment_gb/worldpay/md5_secret` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報の編集を許可 | `payment_gb/worldpay/fix_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報を非表示 | `payment_gb/worldpay/hide_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 署名フィールド | `payment_gb/worldpay/signature_fields` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_gb/worldpay/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| テストの支払アクション | `payment_gb/worldpay/test_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_gb/worldpay/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_gb/worldpay/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_gb/worldpay/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 注文ステータスを「Suspected Fraud for CVV」に設定 | `payment_gb/worldpay/cvv_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 郵便番号 AVS の注文ステータスを不正疑いに設定 | `payment_gb/worldpay/avs_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_gb/worldpay/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_gb/eway/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 接続タイプ | `payment_gb/eway/connection_type` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_gb/eway/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_gb/eway/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_gb/eway/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_gb/eway/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_gb/eway/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_gb/eway/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_gb/eway/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| Enabled | `payment_us/cybersource/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_us/cybersource/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_us/cybersource/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 新規注文ステータス | `payment_us/cybersource/order_status` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_us/cybersource/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_us/cybersource/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_us/cybersource/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_us/cybersource/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最小注文合計 | `payment_us/cybersource/min_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 最大注文合計 | `payment_us/cybersource/max_order_total` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_us/cybersource/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_us/worldpay/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_us/worldpay/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報の編集を許可 | `payment_us/worldpay/fix_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 連絡先情報を非表示 | `payment_us/worldpay/hide_contact` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 署名フィールド | `payment_us/worldpay/signature_fields` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_us/worldpay/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| テストの支払アクション | `payment_us/worldpay/test_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_us/worldpay/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_us/worldpay/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_us/worldpay/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 注文ステータスを「Suspected Fraud for CVV」に設定 | `payment_us/worldpay/cvv_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 郵便番号 AVS の注文ステータスを不正疑いに設定 | `payment_us/worldpay/avs_fraud_case` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 並べ替え順序 | `payment_us/worldpay/sort_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `payment_us/eway/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 接続タイプ | `payment_us/eway/connection_type` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| タイトル | `payment_us/eway/title` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 支払いアクション | `payment_us/eway/payment_action` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| デバッグ | `payment_us/eway/debug` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クレジットカードのタイプ | `payment_us/eway/cctypes` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 対象国からの支払い | `payment_us/eway/allowspecific` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 特定国からの支払い | `payment_us/eway/specificcountry` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
