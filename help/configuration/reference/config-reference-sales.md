...
| ギフトカード | `sales/totals_sort/giftcardaccount` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 店舗クレジット | `sales/totals_sort/customerbalance` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| 注文レベルでギフトの折り返しを許可する | `sales/gift_options/wrapping_allow_order` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 注文品目のギフト ラッピングを許可する | `sales/gift_options/wrapping_allow_items` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| ギフト受領書を許可 | `sales/gift_options/allow_gift_receipt` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 印刷されたカードを許可 | `sales/gift_options/allow_printed_card` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 印刷されたカードの既定の価格 | `sales/gift_options/printed_card_price` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| ストアフロントのマイアカウントで SKU による並べ替えを有効にする | `sales/product_sku/my_account_enable` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| 顧客グループ | `sales/product_sku/allowed_groups` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| アーカイブを有効にする | `sales/magento_salesarchive/active` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 購入済み注文のアーカイブ | `sales/magento_salesarchive/age` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 注文ステータスをアーカイブ済み | `sales/magento_salesarchive/order_statuses` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| ストアフロントでの RMA の有効化 | `sales/magento_rma/enabled` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 製品レベルで RMA を有効にする | `sales/magento_rma/enabled_on_product` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| ストアアドレスを使用 | `sales/magento_rma/use_store_address` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| Enabled | `sales_email/magento_rma/enabled` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| RMA メール送信者 | `sales_email/magento_rma/identity` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| RMA メールテンプレート | `sales_email/magento_rma/template` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| ゲスト用 RMA メールテンプレート | `sales_email/magento_rma/guest_template` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| RMA メールコピーの送信方法 | `sales_email/magento_rma/copy_method` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `sales_email/magento_rma_auth/enabled` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| RMA 認証メール送信者 | `sales_email/magento_rma_auth/identity` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| RMA 認証メールテンプレート | `sales_email/magento_rma_auth/template` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| ゲスト用 RMA 認証メールテンプレート | `sales_email/magento_rma_auth/guest_template` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| RMA 認証メールのコピー方法を送信 | `sales_email/magento_rma_auth/copy_method` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `sales_email/magento_rma_comment/enabled` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| RMA コメントメール送信者 | `sales_email/magento_rma_comment/identity` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| RMA コメントメールテンプレート | `sales_email/magento_rma_comment/template` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| ゲスト用 RMA コメントメールテンプレート | `sales_email/magento_rma_comment/guest_template` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| RMA メールコピーの送信方法 | `sales_email/magento_rma_comment/copy_method` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| Enabled | `sales_email/magento_rma_customer_comment/enabled` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| RMA コメントメール送信者 | `sales_email/magento_rma_customer_comment/identity` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| RMA コメントの E メール受信者 | `sales_email/magento_rma_customer_comment/recipient` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| RMA コメントメールテンプレート | `sales_email/magento_rma_customer_comment/template` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| RMA メールコピーの送信方法 | `sales_email/magento_rma_customer_comment/copy_method` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
これらの設定値は、の管理者で使用できます。 **ストア** > 設定 > **設定** > **売上** > **税**.

| 名前 | 設定パス | Commerceのみ？ |
|--------------|--------------|--------------|
| 配送用の税クラス | `tax/classes/shipping_tax_class` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| ギフト オプションの税クラス | `tax/classes/wrapping_tax_class` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| ギフト包装価格の表示 | `tax/cart_display/gift_wrapping` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 印刷されたカード価格を表示する | `tax/cart_display/printed_card` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| ギフト包装価格の表示 | `tax/sales_display/gift_wrapping` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 印刷されたカード価格を表示する | `tax/sales_display/printed_card` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| 見積もりの有効期間（分）のプレビュー | `checkout/cart/preview_quota_lifetime` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
これらの設定値は、の管理者で使用できます。 **ストア** > 設定 > **設定** > **売上** > **複数出荷設定**.
...
| RMA に対して有効 | `carriers/ups/active_rma` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| RMA に対して有効 | `carriers/usps/active_rma` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| RMA に対して有効 | `carriers/fedex/active_rma` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| RMA に対して有効 | `carriers/dhl/active_rma` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
| アカウントタイプ | `google/analytics/type` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| コンテンツ実験の有効化 | `google/analytics/experiments` | <!-- ![Not Commerce-only](/help/assets/configuration/red-x.png) --> |
| カタログページのリストプロパティ | `google/analytics/catalog_page_list_value` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| クロスセル ブロックのリストプロパティ | `google/analytics/crosssell_block_list_value` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| アップセル ブロックのリスト プロパティ | `google/analytics/upsell_block_list_value` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 関連製品ブロックのリストプロパティ | `google/analytics/related_block_list_value` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| 検索結果ページのリストプロパティ | `google/analytics/search_page_list_value` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
| プロモーションフィールド「ラベル」の「内部プロモーション」。 | `google/analytics/promotions_list_value` | ![Commerce専用](/help/assets/configuration/cloud-ee.png) |
...
これらの設定値は、の管理者で使用できます。 **ストア** > 設定 > **設定** > **売上** > **ギフトカード**.
