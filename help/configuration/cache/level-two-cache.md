...
>[!NOTE]
>
>従来のL2 キャッシュの設定手順は、古いバージョンのAdobe Commerceに適用されます。 Adobe Commerce バージョン 2.4.9以降を使用している場合、Adobeでは[Symfony 2をL2 キャッシュに使用することをお勧めします](#modern-symfony-l2-cache-implementation)。
