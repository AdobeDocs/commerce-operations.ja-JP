...
[必要システム構成](../../installation/system-requirements.md) は、Vanrish のサポートされているバージョンを示します。

>[!WARNING]
>
>水 _強く勧める_ 制作時にはワニスを使用します。 組み込みのフルページ・キャッシュ：ファイル・システムまたは [データベース](https://developer.adobe.com/commerce/php/development/cache/partial/database-caching/) — は Vanrish よりもはるかに遅く、Vanrish は HTTP トラフィックを高速化するように設計されています。
