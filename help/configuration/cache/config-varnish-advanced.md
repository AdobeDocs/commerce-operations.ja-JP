...
最後に、すべてのCommerce インスタンスが実稼動モードである必要があります。 Varnish を起動する前に、各インスタンスのキャッシュをクリアします。 管理画面で、**システム** / ツール / **キャッシュ管理** に移動し、「**Magentoキャッシュをフラッシュ**」をクリックします。 次のコマンドを実行してキャッシュをクリアすることもできます。
