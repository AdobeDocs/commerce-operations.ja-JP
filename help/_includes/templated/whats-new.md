...
<table style="table-layout:auto;">
  ...
  <tbody>
    ...
    <tr>
      <td><p>2024 年 6 月のパッチリリースに従って <a href="https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/system-requirements"> システム要件 </a> を更新しました。 また、システム要件テーブルの表現も変更しました。</p>
</td>
      <td>技術</td>
    ...
    <tr>
      <td><p><a href="https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/system-requirements"> システム要件 </a> の 2.4.5-p7 および 2.4.5-p8 でのRabbitMQのサポートを更新しました。</p>
</td>
      <td>技術</td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>CommerceのExperience Manager Assets統合（プライベートベータ版）に <a href="https://experienceleague.adobe.com/en/docs/commerce-operations/release/beta"> ベータ版情報 </a> を追加しました。</p>
</td>
      <td>major-update</td>
    ...
    <tr>
      <td><p>サードパーティの拡張機能を <a href="https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/tutorials/extensions"> アンインストール </a> する手順を追加しました。</p>
</td>
      <td>major-update</td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p><a href="https://experienceleague.adobe.com/en/docs/commerce-operations/release/planning/lifecycle-policy"> ソフトウェアライフサイクルポリシー </a> におけるサードパーティの依存関係のサポートを明確にしました。</p>
</td>
      <td>major-update</td>
