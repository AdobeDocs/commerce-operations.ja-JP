...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p><a href="https://experienceleague.adobe.com/ja/docs/commerce-operations/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68451">ACSD-68451のQPT 1.1.75修正に関する詳細な説明を追加しました。会社の管理者が1つのweb サイトでログインし、別のweb サイトで無関係な会社を作成し、その無関係な会社に誤ってリンクされる複数のweb サイトの問題を修正します</a>。</p>
</td>
      <td>
        新しいトピック、qpt
      </td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p><a href="https://experienceleague.adobe.com/ja/docs/commerce-operations/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68615">ACSD-68615のQPT 1.1.75修正に関する詳細な説明を追加しました。在庫予約補償CLIでは、処理された組み合わせに注文IDが欠落している場合に例外が表示されました</a>。</p>
</td>
      <td>
        新しいトピック、qpt
      </td>
    ...
    <tr>
      <td><p><a href="https://experienceleague.adobe.com/ja/docs/commerce-operations/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68490">ACSD-68490のQPT 1.1.75修正に関する詳細な説明を追加しました：「新規属性を追加」ボタンは、設定可能な製品作成中に制限付き管理者ユーザーに対して表示されます</a>。</p>
</td>
      <td>
        新しいトピック、qpt
      </td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p><a href="https://experienceleague.adobe.com/ja/docs/commerce-operations/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/overview">概要：品質パッチツール （QPT） v1.1.75</a>を追加しました。</p>
</td>
      <td>
        新しいトピック、qpt
      </td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    <tr>
      <td><p>2026年のリリースプランを反映するため、<a href="https://experienceleague.adobe.com/ja/docs/commerce-operations/release/planning/schedule">Commerce パッチリリーススケジュール </a>を更新しました。</p>
</td>
      <td>
        技術的、フィードバック
      </td>
...
<table style="table-layout:auto;">
  ...
  <tbody>
    ...
    <tr>
      <td><p><a href="https://experienceleague.adobe.com/ja/docs/commerce-operations/installation-guide/system-requirements"> システム要件</a>:<br />- コアバージョン 2.4.4-2.4.6 （基本およびパッチ）のComposer依存関係を更新：v2.2.26に更新しました。<br />- 2.4.7以降（基本およびパッチ、2.4.8および2.4.9-alpha バージョンを含む）:v2.9.3に更新しました。</p>
</td>
      <td>
        テクニカル
      </td>
