...
次のリファレンスドキュメントは、 `composer.lock` ファイルで、cloud infrastructure 2.4.6 上のAdobe Commerceに含まれている必要なパッケージについて説明します。
...
<table>
  ...
  <tr>
    ...
    <td>ライブラリ</td>
    <td>従来の ZF クラス名を Laminas Project と同等の名前にエイリアスします。</td>
  </tr>
  <tr>
    <td>
...
<table>
  ...
  <tr>
    ...
    <td>ライブラリ</td>
    <td>すべての非推奨（廃止予定）を無効にするオプションや、パッケージに対して選択的に実行するオプションを備えた、トリガーエラー（E_USER_DEPRECATED）または PSR-3 ログの上の小さなレイヤー。</td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    ...
    <td>ライブラリ</td>
    <td>ICU ライブラリからの追加データを含む C intl 拡張機能用の PHP 置換レイヤーを提供します</td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    <td>
      <a href="https://github.com/thecodingmachine/safe.git">ecodingmachine/safe</a>
    </td>
    <td>ライブラリ</td>
    <td>エラー時に FALSE を返すのではなく、例外をスローする PHP コア関数</td>
  </tr>
  <tr>
    <td>
...
<table>
  ...
  <tr>
    ...
    <td>magento2-module</td>
    <td>Temando の配送用マルチキャリア拡張機能をMagento 2 から削除します</td>
  </tr>
  </tbody>
</table>
...
<table>
  ...
  <tr>
    ...
    <td>隠喩</td>
    <td>Magento2 向け Temando マルチキャリア配送延長</td>
  </tr>
  </tbody>
</table>
