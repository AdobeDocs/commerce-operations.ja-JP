...
_ACP2E-4395 - [GitHubの問題](https://mcstaging.panini.it/shp_ita_it/)_
...
_AC-14520 - [GitHub issue](https://github.com/magento/magento2/issues/39823) - [GitHub コード投稿](https://github.com/magento/magento2/commit/1e14bd72) - [GitHub コード投稿](https://github.com/magento/magento2/commit/1514117f)_
...
_ACP2E-4052 - [GitHubの問題](https://stg1.navi-online.kakuyasu.co.jp/adminCgWN7zCh/admin/system_account/index/key/d6fdbee50ff25178d1fef981ec823c5e82e8cee6959717790031bb900c4d6633/) - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/52f46328)_
...
_ACP2E-4104 - [GitHubの問題](https://mcprod.pap-store.acer.com/index.html)_
...
_ACP2E-4337 - [GitHubの問題](https://mcstaging.pap-store.acer.com) - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/31258bf6)_
...
#### 管理者アクションログユーザーレポートには、フィルターの適用時に使用されたフィルターの詳細が表示されません
...
修正の前は、ログアウトアクションがカートページで正しく完了していませんでした。この問題が解決しない場合は、長いユーザー会社が有効になっていません。 これで、会社が利用できなくなった場合、ログアウトが適切に実行されます。
...
_ACP2E-4245 - [GitHubの問題](https://www.techbuyer.com/) - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/cbca0396)_
...
_ACP2E-4266 - [GitHubの問題](https://mcstaging.casamyers.com.mx/) - [GitHub コードの貢献度](https://github.com/magento/inventory/commit/ae1f272f)_
...
_ACP2E-4379 - [GitHubの問題](https://www.panini.it)_
...
_ACP2E-4128 - [GitHubの問題](https://ansg.integration-5ojmyuq-f46gejjrfa7be.ap-3.magentosite.cloud/) - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/e457c5e2)_
...
#### [\Magento\ConfigurableProduct\Model\Product\Type\Configurable] PHP エラーが検出されませんでした
...
システムが並べ替えるようになりましたデータベース内の最新の製品（entity_idが最も高い製品）が最初に表示されます
...
ネストされたカテゴリの数が多い環境の作成時のスケジュールされた更新中に重複するエントリに関する問題を修正しました

_ACP2E-4159 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/a1c57b2e)_

#### [CLOUD]異なるストアの製品数の不一致の問題を比較
...
このPRでは、複数値のフォーム要素がweb サイト/グループ/ストアフォームにデータを送信できるようにします。
...
このPRは、\Magento\Framework\Message\ManagerInterfaceの不正なphpdocを修正し、\Magento\Framework\Message\Manager内のすべての重複したphpdocを削除します（inheritdoc syntaxeを使用）。
...
#### [問題] レイアウト XML結合の読み込み中に多くの不必要な例外を回避する
...
_AC-14883 - [GitHub issue](https://github.com/magento/magento2/issues/39947) - [GitHub コード投稿](https://github.com/magento/magento2/commit/3717e6cb) - [GitHub コード投稿](https://github.com/magento/magento2/commit/8b453942) - [GitHub コード投稿](https://github.com/magento/magento2/commit/d3ea191d)_
...
_AC-15446 - [GitHub issue](https://github.com/magento/magento2/issues/40170) - [GitHub コード投稿](https://github.com/magento/magento2/commit/059fd469) - [GitHub コード投稿](https://github.com/magento/magento2/commit/e9412b24)_
...
_ACP2E-4060 - [GitHubの問題](https://integration-5ojmyuq-3ssteurpe3xzy.us-5.magentosite.cloud/) - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/6dd3fa99)_
...
修正の前は、head セクションを通じてカスタム JavaScriptを読み込むと、問題が発生する可能性がありました。 新しい設定の導入後、このようなスクリプトは自動的に破棄され、Magento 2 フレームワークとの互換性が高まります。
...
_ACP2E-3805 - [GitHubの問題](https://mcstaging.briscoes.co.nz/)_
...
修正前は、エラーノードの位置は、2.4.7および2.4.9のバージョンとのシームレスな互換性を提供していませんでした。 修正が完了すると、エラーノードが適切に配置され、両方のバージョンに対応するようになりました。
...
この修正を行う前は、子商品がカスタムソースで在庫を持っている場合、バンドル価格は適切にインデックス化されていませんでした。 修正の後、バンドル価格は、子製品在庫の割り当てに関係なく適切にインデックス付けされます。
...
#### 日付のフィルタリングは、あいまいなフィールド名のため機能しません
...
修正前は、非同期メール送信を使用する際に、配送メールがストア注文と一致していませんでした。 これで、修正後、適切な店舗の配送メール注文が配信されます。
...
3rd パーティのコントローラーが顧客セグメントに正しくキャッシュされるようになりました
...
修正の前は、リモートストレージのメタデータに使用されるキャッシュキーが期限切れになっていませんでした。 修正の後、依存関係インジェクションを通じてそのようなキャッシュキーのTTLを設定できます。
...
_ACP2E-4112 - [GitHubの問題](https://adobe-ent.crm.dynamics.com/main.aspx?appid=f2e74f34-7119-ea11-a811-000d3a5936c5&forceUCI=1&pagetype=entityrecord&etn=incident&id=3e1df344-8a69-f011-bec3-6045bd04f475)_
...
修正前は、生成されたバンドルまたは結合されたファイルがSRI ハッシュリストに追加されていませんでした。 現在、ファイルは適切にSRI ハッシュに追加されています。
...
修正前は、ステージングプレビューモードでクーポンコードを正しく使用できませんでした。 修正が完了すると、チェックアウトページにバウチャーコードが正しく適用されるようになりました。
