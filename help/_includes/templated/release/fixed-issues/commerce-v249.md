...
Adobe Commerce 2.4.9 コアコードの667の問題を修正しました。 このリリースに含まれる修正された問題のサブセットについて、以下で説明します。
...
_AC-12321 - [GitHub issue](https://github.com/magento/magento2/issues/38827) - [GitHub コードの貢献度](https://github.com/magento/magento2/pull/38864)_
...
_AC-1608 - [GitHub issue](https://github.com/magento/magento2/issues/34342) - [GitHub コードの貢献度](https://github.com/magento/magento2/pull/34897)_
...
_ACP2E-4621 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/c12a7510)_
...
_AC-16227 - [GitHub issue](https://github.com/magento/magento2/issues/40361) - [GitHub コードの貢献度](https://github.com/magento/magento2/pull/40416)_
...
_AC-16504 - [GitHub issue](https://github.com/magento/magento2/issues/40521) - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/57bad413)_
...
_AC-16659 - [GitHub issue](https://github.com/magento/magento2/issues/40570) - [GitHub コードの貢献度](https://github.com/magento/magento2/pull/40563)_
...
_ACP2E-4527 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/f2fd9628)_
...
_ACP2E-4554 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/aa2e16d1)_
...
_ACP2E-4524 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/aa2e16d1)_
...
_AC-16378 - [GitHub issue](https://github.com/magento/magento2/issues/40468) - [GitHub コードの貢献度](https://github.com/magento/magento2/pull/40225)_
...
_AC-16550 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/8391dbcc)_
...
_ACP2E-4447 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/e2b23caa)_

#### 非同期グリッドインデックスが有効になっている場合、最新の注文データとアーカイブグリッドが同期されない

販売注文アーカイブグリッドに、非同期インデックス付きの正しい注文ステータスが表示されるようになりました

_ACP2E-4493 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/f2fd9628)_

#### 製品属性の一括更新による製品タイプの変更Virtual->Simple

「これは重みがありますか？」を防ぎます。 属性パネルの一括更新が挿入される前にアクティブ化されるコントロールを使用して、バーチャル製品の意図しない重み付けの変更を回避します。

_ACP2E-4500 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/e2b23caa)_
...
_ACP2E-4630 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/d8a248cd)_
...
_ACP2E-4675 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/c58a8ad0) - [GitHub コードの貢献度](https://github.com/magento/magento2-page-builder/commit/5fd20dbb)_
...
_ACP2E-4698 - [GitHub コードの貢献度](https://github.com/magento/magento2-page-builder/commit/5fd20dbb)_
...
_ACP2E-4605 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/c12a7510)_
...
#### お客様の追加ページと編集ページの「会社に関連付ける」フィールドで、UI フォームのリセットボタンが期待どおりに機能しない

リセットボタンが顧客の追加/編集フォームの「会社に関連付ける」フィールドを正しくリセットしなかった問題を修正しました。 フォームは、ページをリロードしなくても、すべてのフィールドを適切にリセットし、期待される動作を復元するようになりました。
...
_ACP2E-4724 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/c58a8ad0)_
...
_ACP2E-4615 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/c58a8ad0)_
...
_ACP2E-4488 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/f2fd9628)_
...
_ACP2E-4626 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/c12a7510)_
...
#### ギフトカードアカウントの有効期限フィールドでの入力処理の問題

管理画面でギフトカードアカウントを作成または編集する際に、「有効期限」フィールドが適切に検証されるようになりました。 以前は、有効な日付形式と一致しない手動で入力した値が、アカウントの保存時に誤って処理される可能性がありました。
...
_AC-16639 - [GitHub issue](https://github.com/magento/magento2/issues/40590) - [GitHub コードの貢献度](https://github.com/magento/magento2/pull/40463)_
...
_ACP2E-4363 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/e2b23caa)_

#### analytics_collect_data cronの実行による[CLOUD] パフォーマンスの低下

分析のcron ジョブに関連するパフォーマンスを向上します。

_ACP2E-4496 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/f2fd9628)_
...
#### チェックアウトに進み、ログイン中に顧客を会社に割り当てた後、カートに表示されない見積もりをリクエスト

ストアフロントでログイン中に顧客が会社に割り当てられている場合、「チェックアウトに進む」ボタンと「見積もりを依頼」ボタンがカートページに表示されない問題を修正しました。 この修正後、両方のボタンが直ちに表示され、お客様がログアウトして再度ログインする必要はありません。
...
_ACP2E-4608 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/c12a7510)_
...
#### Google Payで複数のクーポンが期待どおりに機能しない

Google Pay Express支払いシート内で複数のクーポンコードが期待どおりに機能しない問題を修正しました。 以前は、2番目のクーポンコードを適用すると、最初のクーポンの割引が誤って削除され、不正確な合計が表示されていました。 クーポンを削除しても、支払いシートが正しく更新されませんでした。
お客様は、Google Pay Express Pay Sheetで複数のクーポンコードを適用できるようになり、すべての割引が正確に反映されます。

_バンドル–3507_

#### 「後払い」メッセージが無効になっている場合でも、Braintree SDKはすべてのページでクライアントトークンを取得するように呼び出されます

「後払い」メッセージが無効になっている場合でも、Braintree SDKは、ページ読み込み時にクライアントトークンを取得する呼び出しを行っていました。 その結果、不要なリクエストや潜在的なパフォーマンス問題が発生しました。
PayPal支払い方法とカートの後払いメッセージの両方が有効になっている場合にのみ、Braintree クライアントトークンがリクエストされるようになりました。 これにより、不要なトークン要求を防ぎ、ページ読み込みのパフォーマンスを向上させます。

_バンドル–3508_

#### Braintreeのお支払い方法のテンプレートとjs ファイルのレンダリングを、お客様のアカウントエリアの「お支払い方法の保存」セクションで停止する

JavaScriptおよびBraintreeの支払い方法のテンプレートファイルは、Braintreeの支払い方法と保管の設定が無効になっている場合でも、お客様のアカウントエリアの「ストアド支払い方法」セクションにレンダリングされていました。 これにより、ブラウザーコンソールで不要なエラーが発生しました。
関連するファイルとフォームをレンダリングする前に、Braintreeの支払い方法とヴォールティング設定が有効になっているかどうかを確認できるようになりました。 両方が有効になっている場合にのみ、保管テンプレートとスクリプトが「支払い方法の保存」セクションに表示されます。

_バンドル–3509_

#### Apple PayとGoogle Pay サードパーティとの互換性の問題

お客様が、サードパーティのチェックアウト拡張機能（Hyvä Checkoutなど）またはカスタマイズ機能を使用してApple PayまたはGoogle Payで支払いを行おうとすると、エラーが発生しました。 具体的には、Apple Payではマーチャント名が欠落しているためTypeErrorがスローされ、カスタムコードのインタラクションによってはGoogle Payも失敗する可能性があります。
Apple PayとGoogle Payの互換性に関する問題が解決されました。 サードパーティのチェックアウト拡張機能とカスタマイズが適切に処理され、必要な設定値が存在し、正しく返されるようになりました。

_バンドル–3510_

#### Braintree経由のGoogle Payでは、決済時に無制限に読み込みをおこなうことができます

BraintreeでGoogle Payが有効になっている場合、支払い方法としてGoogle Payを選択すると、チェックアウトプロセスは無限読み込み状態になります。 これにより、エラーメッセージやフィードバックが提供されることなく、顧客は注文を完了することができませんでした。
Braintreeを介したGoogle Payの統合は、支払いフローが期待どおりに進行するように修正されました。 お客様は、決済時にGoogle Payを選択し、支払いプロセスを完了して、注文を正常に行えるようになりました。
...
_AC-14460 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/57bad413)_
...
_AC-15963 - [GitHub issue](https://github.com/magento/magento2/issues/40255) - [GitHub コードの貢献度](https://github.com/magento/magento2/pull/40248)_
...
_AC-16417 - [GitHub issue](https://github.com/magento/magento2/issues/40503) - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/8391dbcc)_
...
#### Recaptcha v2でギフトカードを適用する際の[CLOUD]の問題（「私はロボットではありません」）

reCAPTCHA検証に成功した後、reCAPTCHA v2 （「私はロボットではありません」）が有効になっている場合に、ギフトカードが正しく適用されるようになりました。
...
_ACP2E-4472 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/e2b23caa)_

#### 定額送料と送料無料によるバンドル製品の動作の一貫性の欠如

修正前は、カートの割引ルールを通じて提供された場合、バンドル商品の送料無料が適切に計算されていませんでした。 修正後、バンドル製品の送料無料が適切に計算されます。

_ACP2E-4536 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/c12a7510)_

#### 数値SKUを持つ製品の注文はできません

数値SKUを持つ製品の注文時にエラーが発生しなくなりました。

_ACP2E-4669 - [GitHub コードの貢献度](https://github.com/magento/inventory/commit/83d11138)_
...
_ACP2E-4735 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/c58a8ad0)_
...
#### quote_coupons テーブルの[ クーポン ]断続的な重複クーポン入力エラー

複数の買い物かごの結合または見積もりの保存リクエストが同時に実行された場合に、quote_coupons テーブルで断続的な重複キーエラーを解決しました。
...
_ACP2E-4491 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/e2b23caa)_
...
_ACP2E-4673 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/c58a8ad0)_
...
_AC-14541 - [GitHub issue](https://github.com/magento/magento2/issues/39863) - [GitHub コードの貢献度](https://github.com/magento/magento2/pull/40421)_
...
_AC-14626 - [GitHub issue](https://github.com/magento/magento2/issues/35670) - [GitHub コードの貢献度](https://github.com/magento/magento2/pull/40412)_
...
_AC-15044 - [GitHub issue](https://github.com/magento/magento2/issues/40027) - [GitHub コードの貢献度](https://github.com/magento/magento2/pull/40431)_
...
_AC-15746 - [GitHub issue](https://github.com/magento/magento2/issues/40205) - [GitHub コードの貢献度](https://github.com/magento/magento2/pull/40203)_
...
_AC-16380 - [GitHub issue](https://github.com/magento/inventory/issues/3384) - [GitHub コード投稿](https://github.com/magento/inventory/pull/3385) - [GitHub コード投稿](https://github.com/magento/inventory/commit/b4aeda50)_
...
_AC-16437 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/57bad413)_
...
修正後、`--skip_hidden_images` フラグで使用される`catalog:images:resize` コマンドは、画像が存在しないweb サイトの画像キャッシュを生成しません。
...
_ACP2E-4505 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/f2fd9628)_

#### 子ページ URL キーが変更された場合、CMS階層は階層URLを更新しません（2.4.8-p3）

CMS ページのURL キーを変更しても、ページの階層URLが更新されない問題を修正しました（例：/help/my-accountは、my-account-2に名前を変更した後も同じでした）。 階層更新ロジックにページ独自のノードが正しく含まれるようになり、request_urlが更新され、新しいパス（例：/help/my-account-2）が期待どおりに動作するようになりました。
...
_ACP2E-4533 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/aa2e16d1)_

#### テーブル magento_catalogpermissions_index_productの[CLOUD]のデッドロック。 続き

修正の前に、カタログ権限の製品インデックスを実行すると、既存の権限インデックス行が変更されないままになる可能性があるため、更新されたカテゴリ権限の付与が製品に確実に反映されませんでした。
修正の後、インデックス再作成は既存の権限インデックス行を正しく更新するので、権限の変更はストアフロントへのアクセス、価格表示、チェックアウトの可用性に一貫して適用されます。

_ACP2E-4603_

#### ターゲットルールインデクサーのcronは、ストアビューの範囲でのみ有効な製品を選択しません

修正の前は、Admin スコープで有効になっていない製品は、ターゲットルールインデクサーで取得されていませんでした。 修正の後、少なくとも1つのスコープで有効になっている場合は、製品がピックアップされます。
...
_ACP2E-4529 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/f2fd9628)_
...
#### フィールド値に`\`が含まれている場合、管理者パネル `listing component`の[小さなバグ ] フィルターをヒットできません
...
_AC-16686 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/0c9a749b)_
...
#### [ADOBE STOCK]統合が無効になっている場合でも、「Adobe Stock検索ファイルの結果を取得できませんでした」に関する重要なログが表示されます。

Adobe Stock統合が無効になっている場合、「Adobe Stock検索ファイルの結果を取得できませんでした」というエラーが記録されなくなりました。
...
#### お客様の管理者の[管理者][Customer] パスワードのリセットが失敗しています

管理者パネルから顧客のパスワードをリセットすると、システムエラーとページがクラッシュする問題を修正しました。 ストアの変更を伴うエッジケースでも、パスワードリセットが正しく機能し、リセットリンクをエラーなしで送信するようになりました。

_AC-14940 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/3e41a43b)_
...
#### [問題] `comment=""`を使用した`db_schema.xml`の宣言がダウンタイムなしのデプロイメントを壊さないようにします
...
#### [問題] `Magento_Backup`および`Magento_Bundle`から禁止されている`@author` タグを削除
...
_ACP2E-4512 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/e2b23caa)_
...
_ACP2E-4585 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/aa2e16d1)_
...
_ACP2E-4762 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/c58a8ad0)_
...
_ACP2E-4587 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/c12a7510)_
...
_ACP2E-4481 - [GitHub コードの貢献度](https://github.com/magento/inventory/commit/96b77663)_
...
_ACP2E-4509 - [GitHub コードの貢献度](https://github.com/magento/inventory/commit/a33c60f2)_
...
_ACP2E-4519 - [GitHub コードの貢献度](https://github.com/magento/inventory/commit/40858072)_
...
_ACP2E-4403 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/c12a7510)_
...
_AC-14848 - [GitHub issue](https://github.com/magento/magento2/issues/39884) - [GitHub コードの貢献度](https://github.com/magento/magento2/pull/40428)_
...
_AC-16256 - [GitHub issue](https://github.com/magento/magento2/issues/40403) - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/3e41a43b)_
...
_AC-16680 - [GitHub コードの貢献度](https://github.com/magento/inventory/commit/d3b2ef0b)_
...
_ACP2E-4455 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/e2b23caa)_

#### クーポンの使用は、注文のキャンセル/拒否に対して元に戻りません

注文をキャンセルすると、注文ステータス設定が変更された場合でも、適用されたクーポンの使用状況が正しくリセットされるようになりました。 これにより、注文ステータスのカスタム設定が有効な場合、注文がキャンセルされた後も、クーポンが「使用済み」としてマークされたままになる可能性があります。
...
#### 登録ユーザーに対する顧客セグメントの遅延に基づくカート価格ルール

登録ユーザーに対して、顧客セグメントに基づくカート価格ルールがすぐに適用されない問題を修正しました。 トークンの更新を必要とせずに、対象となる商品をカートに追加すると、割引が正しく適用されるようになりました。
...
_ACP2E-4601 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/c12a7510)_
...
#### [CLOUD][CLOUD] [Mainline] sales_clean_quotes getSize （） ボトルネック

sales_clean_quotes cron ジョブのパフォーマンスを向上させます。

_ACP2E-4610 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/c58a8ad0)_
...
_ACP2E-4689 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/d8a248cd)_

#### magento_reward_history テーブルのデータが大きいため、クエリのパフォーマンスが遅い

大規模なmagento_reward_history テーブルで報酬ポイントの有効期限cron ジョブが遅く実行される問題を修正しました。 以前は、スケジュールされたポイントの有効期限で使用されるクエリに複合データベースインデックスが不足していたため、数百万レコードのテーブルに対して完全なテーブルスキャンが実行されていました。
...
_ACP2E-4475 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/f2fd9628) - [GitHub コードの貢献度](https://github.com/magento/inventory/commit/a33c60f2)_
...
_AC-15494 - [GitHub issue](https://github.com/magento/magento2/issues/40178) - [GitHub コードの貢献度](https://github.com/magento/magento2/pull/40423)_
...
#### ターゲットルールの増分インデクサーが無効な製品を選択しない

ターゲットルールの増分インデックスは、製品が有効または無効になっている場合に応答するようになり、完全なインデックス再作成なしで関連/アップセル/クロスセルのレコメンデーションが更新されるようになりました。

_ACP2E-4402_

#### Rest APIで顧客セグメンテーションが正しく機能しない

REST APIを介して注文が行われた場合、注文数に基づく顧客セグメントが正しく更新されるようになりました。 以前は、オブザーバーが顧客セッションに依存していたため、API注文に対するセグメントメンバーシップは更新されませんでした。顧客セッションはAPI リクエストでは利用できません。
...
_ACP2E-4653 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/d8a248cd)_

#### 送料無料のカート価格ルールが、バンドル製品で期待どおりに機能しない

送料無料の改善された取り扱い

_ACP2E-4720 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/c58a8ad0)_

### 返品

#### バンドル製品を返す際の簡単なオプション選択の問題

以前は、この修正が実装される前は、返品のために商品を別々に出荷するオプションを持つバンドル製品の場合、「商品を選択」機能はポップアップブロックを初めて開いただけです。 ポップアップブロックを選択または閉じた後、「項目を選択」機能が呼び出されるたびにブロックが開かれませんでした。 ただし、この修正を適用すると、問題は解決され、機能は意図したとおりに動作するようになりました。
...
_AC-16626 - [GitHub issue](https://github.com/magento/magento2/issues/40580) - [GitHub コードの貢献度](https://github.com/magento/magento2/pull/40581)_
...
_AC-16577 - [GitHub issue](https://github.com/magento/magento2/issues/40394) - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/15a9362d)_
...
_ACP2E-4556 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/aa2e16d1)_
...
_AC-16530 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/57bad413)_
...
_ACP2E-4433 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/f2fd9628)_
...
_ACP2E-4411 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/aa2e16d1)_
...
_AC-16018 - [GitHub issue](https://github.com/magento/magento2/issues/40253) - [GitHub コードの貢献度](https://github.com/magento/magento2/pull/40239)_
