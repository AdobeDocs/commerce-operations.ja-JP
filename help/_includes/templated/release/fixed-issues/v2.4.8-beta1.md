...
* _AC-11810_:Magento2.4.6-p4 受注 API 単純品欠落価格
...
* _AC-12880_：すべてのバンドルされた拡張機能の日別ビルド – 魅力的なレポートが生成されない
   * _メモの修正_：エラーなく Allure レポートを生成する必要がある
...
* _AC-12669_：ページビルダーテストで Vimeo/YouTube ビデオのアサーション再生が失敗する
...
* _AC-11806_：行 253 で SchemaBuilder.php のMagentoを更新できないエラーが発生する
   * _GitHub の問題_:<https://github.com/magento/magento2/issues/38592>
