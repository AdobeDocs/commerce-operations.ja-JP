...
Magento Open Source 2.4.8 リリースには、次の31のハイライトが適用されます。

### フレームワーク

#### リーグ/フライシステム Composer依存関係を最新バージョンにアップグレードする

2.x league/flysystem Composer依存関係を最新バージョン 3.xにアップグレードします。

_AC-10721 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/91cb4d46)_

#### php-amqplib/php-amqplibの最新バージョンを調査する

最新バージョン php-amqplib/php-amqplib :^3.xを更新しました

_AC-11673 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/de4dfb8e)_

#### jQuery/fileuploader cssのクリーンアップは、ライブラリをアップピーする移行後に行います

Uppy ライブラリに移行されたため、jQuery/fileUploader ライブラリを削除しました

_AC-11911 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/7cabfb46)_

#### Magento CE用MySQL 8.4 LTSとの互換性を追加

説明はありません。

_AC-11995 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/672a2e61)_

#### JsTree ライブラリへの移行後のExtJs フォルダーのクリーンアップ

関連機能がjsTreeに移行されたため、extJs フォルダーを削除しました

_AC-12015 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/7cabfb46)_

#### モノログ/モノログシステム依存関係を最新のメジャーバージョンにアップグレードする

「monolog/monolog:^3.x」ライブラリの最新メジャーバージョンを使用するようにシステムが更新され、互換性とパフォーマンスが向上しました。 以前は、システムは古いバージョンの「monolog/monolog」ライブラリを使用しており、潜在的な問題や制限が発生する可能性がありました。

_AC-12022 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/edcd0dcc)_

#### wikimedia/less.phpの依存関係を最新のメジャーバージョンにアップグレードする

システムが更新され、「wikimedia/less.php」ライブラリの最新のメジャーバージョン 5.xが使用されるようになり、互換性と最新の機能が確保されました。 以前は、システムが古いバージョンのライブラリを使用しており、セキュリティ上の問題が発生していた可能性がありました。

_AC-12023 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/edcd0dcc)_

#### jquery/validate ライブラリの依存関係を最新のマイナーバージョンにアップグレードします

jquery/validate ライブラリの依存関係を最新のマイナーバージョン 1.20.0にアップグレードします

_AC-12024 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/de4dfb8e)_

#### moment.js システム依存関係を最新のマイナーバージョンにアップグレードする

moment.js システム依存関係を最新のマイナーバージョン 2.30.1にアップグレードする

_AC-12025 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/de4dfb8e)_

#### EE用MySQL 8.4 LTSとの互換性を追加

説明はありません。

_AC-12032 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/672a2e61)_

#### B2B向けMySQL 8.4 LTSとの互換性を追加

説明はありません。

_AC-12034 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/672a2e61)_

#### バンドル拡張機能のMySQL 8.4 LTSとの互換性の追加

説明はありません。

_AC-12074 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/672a2e61)_

#### MariaDB 11.4 LTS For CEとの互換性の追加

Adobe Commerceおよび拡張機能を使用したMariaDB 11.4のサポートの追加

_AC-12085 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/b34c0a75)_

#### Subscribers Optimization - PhpUnit10

説明はありません。

_AC-12165 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/90e25b6b)_

#### Redis セッションの接続再試行をサポートし、colinmollenhour/php-redis-session-abstract v2.0.0と互換性があります。

adobe commerceと互換性のあるcolinmollenhour/php-redis-session-abstract v2.0.0の最新バージョンを更新しました

_AC-12267 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/672a2e61)_

#### MySQL 8.4 LTSでの自動化テストの失敗を調査します

説明はありません。

_AC-12576 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/672a2e61)_

#### MariaDB 11.4 LTS For EEとの互換性の追加

Adobe Commerceおよび拡張機能を使用したMariaDB 11.4のサポートの追加

_AC-12595 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/b34c0a75)_

#### laminas composerの依存関係を更新し、最新バージョンにアップグレードする

システムで、laminas composerの依存関係の最新バージョンがサポートされるようになりました。
laminas/laminas-servicemanager
laminas/laminas-server
laminas/laminas-stdlib
laminas/laminas-validator
互換性と最新機能の確保。 以前は、これらの依存関係の最新バージョンに更新すると、後方互換性の問題やテスト失敗が発生する可能性がありました。

_AC-12715 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/b34c0a75)_

#### コンポーネントのアップグレード中にphpunit パッチが更新されたためにユニットテストが失敗したことを調査します

説明はありません。

_AC-12823 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/b34c0a75)_

#### [ パート 1] – すべてのjs ライブラリとnpm依存関係を最新バージョンで更新します

コンポーザーのバージョンのサポートは、コンポーザーのバージョン 2.2.xまででした。 サポートが2.4.x バージョンにも拡張されました。

_AC-13076 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/19844aa0)_

### 注文

#### [機能要求]お客様から、注文詳細ページの「コメントを送信」ボタンが混乱しているため、別のページに変更する必要があることを提案されました

混乱を最小限に抑えるために、注文詳細ページの「コメントを送信」ボタンのラベルが「更新」に変更されました。

_ACP2E-2709 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/488c1034)_

### その他

#### 新しいバージョンのAdobe Commerceがインストールされている場合、Set indexersがReady ステータスのデフォルトで表示されます

Magentoのインストール後、インデクサーのステータスはデフォルトで&#x200B;*Ready*&#x200B;状態である必要があります。

_AC-11420 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/71432aeb)_

#### 既存のMagento インストールでサードパーティのインデクサーモジュールをインストールすると、デフォルトで更新でインデクサーが設定されます。

すべての新しいインデクサーは、デフォルトでは[ スケジュール別に更新] モードです。 以前は、デフォルトのモードは[保存時の更新]でした。 カスタムインデックスも同様です。

_AC-11421 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/71432aeb)_

#### Elasticsearch 7および8のオプションには、管理者設定で非推奨（廃止予定）が含まれている必要があります。

「管理者設定」オプションの「Elasticsearch 8」オプションは、「非推奨」テキストと共に表示され、Elasticsearch 8の使用を推奨されなくなったことをユーザーに通知します。

_AC-12480 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/0611e750)_

#### 管理者設定で「Elasticsearch」オプションが選択されている場合にテキストノートを追加する

テキストノートが追加され、Adobe Commerce管理者ユーザーは、elasticsearchがAdobeでサポートされなくなり、非推奨になったことを知ることができます。

_AC-12481 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/0611e750)_

#### 2.4.8への階層価格運用パフォーマンス改善パッチの提供

このシステムにより、「/V1/products/tier-prices」 REST API エンドポイントを使用する際に、パフォーマンスの問題やサイトの応答性の問題を引き起こさずに、階層価格をより効率的に一括更新できるようになりました。 以前は、このエンドポイントを使用して多数の価格を更新すると、パフォーマンスの問題やサイトの応答性が低下する可能性がありました。

_AC-13448 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/082d981c)_

#### Magento Open Source リポジトリからすべてのAdobeの機密著作権通知を削除する

Adobeの機密著作権表示はすべてオープンソースリポジトリから削除され、Adobeの著作権の縮小版のみが使用されるようになりました。 以前は、パブリックリポジトリ内の一部のファイルにAdobeの機密著作権通知が含まれていたため、コミュニティのエスカレーションにつながっていました。

_AC-13550 - [GitHub issue](https://github.com/magento/magento2/issues/39493) - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/4bca5dfe)_

### UI フレームワーク

#### [2.4.8-beta1] TinyMCE 5への移行

TinyMCE 5をTinyMCE 7.3.0に移行し、以前のシステムは古く、セキュリティ上の脆弱性が報告されていたAdobe Commerceのサポート対象バージョン 5.10.2を使用していました

_AC-12726 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/edcd0dcc)_

#### [2.4.8-beta1] TinyMCE 5のTinyMCE 7 ページビルダーへの移行

TinyMCE 5をTinyMCE 7.3.0に移行し、以前のシステムは古く、セキュリティ上の脆弱性が報告されていたAdobe Commerceのサポート対象バージョン 5.10.2を使用していました

_AC-12825 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/edcd0dcc)_

#### [2.4.8-beta1] TinyMCE 5のTinyMCE 7への移行 – Magento2-infra – 禁止された単語

TinyMCE 5をTinyMCE 7.3.0に移行し、以前のシステムは古く、セキュリティ上の脆弱性が報告されていたAdobe Commerceのサポート対象バージョン 5.10.2を使用していました

_AC-12844 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/edcd0dcc)_

#### Require.jsを最新バージョン 2.3.7にアップグレードする（セキュリティ脆弱性CVE-2024-38999）

require.jsを最新バージョン 2.3.7に更新しました。以前のバージョンで報告されたセキュリティの脆弱性

_AC-12901 - [GitHub コードの貢献度](https://github.com/magento/magento2/commit/b34c0a75)_

## v2.4.8で修正された問題

Magento Open Source 2.4.8 コアコードの497の問題を修正しました。 このリリースに含まれる修正された問題のサブセットについて、以下で説明します。
