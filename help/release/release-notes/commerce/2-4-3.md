...
* マーチャントは、ストア表示ごとにカタログイベントに対して画像を割り当てたり、カタログから削除したりできるようになりました。 以前は、カタログイベントの編集中にストア表示を変更すると、[ **削除画像** チェックボックスがアクティブではなく、アプリケーションに次のエラーが表示されました。 `Uncaught ReferenceError: toggleValueElements is not defined at HTMLInputElement.onclick`。 [GitHub-364](https://github.com/magento/partners-magento2ee/issues/364)
...
* アプリケーション、買い物客が&#x200B;**配送方法と料金を取得**&#x200B;をクリックし、管理者から注文を作成するときに配送方法を選択したときに、[**コメントを追加**&#x200B;チェックボックスをオフにしなくなりました。[GitHub-30256](https://github.com/magento/magento2/issues/30256)
