...
[2}Adobe Sensei](https://experienceleague.adobe.com/en/docs/commerce/live-search/overview) を活用した [ ライブサーチ } では、人工知能と機械学習アルゴリズムを使用して、集計した訪問者データの詳細な分析を行うことで、直感的な検索エクスペリエンスを提供します。](https://www.adobe.com/sensei.html) [Live Search リリースノート ](https://experienceleague.adobe.com/docs/commerce/live-search/release-notes.html) を参照してください。
