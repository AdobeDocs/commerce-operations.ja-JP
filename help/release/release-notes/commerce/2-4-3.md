...
[2}Adobe AI](https://experienceleague.adobe.com/en/docs/commerce/live-search/overview) を活用した [ ライブサーチでは、人工知能と機械学習アルゴリズムを使用して、集計した訪問者データの深い分析を行うことで、直感的な検索エクスペリエンスを提供します。](https://business.adobe.com/ai.html) [Live Search リリースノート ](https://experienceleague.adobe.com/docs/commerce/live-search/release-notes.html) を参照してください。
