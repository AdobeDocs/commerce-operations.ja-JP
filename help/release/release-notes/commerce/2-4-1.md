...
* GraphQLで、オプションタイプのバンドル製品の注文の配置がサポートされるようになりました `radio` および `dropdown` 複数の選択肢があります。 以前は、無効な入力に関するメッセージが `BundleItem.type: radio/dropdown`. _プル要求で Michal l Derlatka から送信された修正 [29256](https://github.com/magento/magento2/pull/29256)_. [GitHub-26110](https://github.com/magento/magento2/issues/26110)
