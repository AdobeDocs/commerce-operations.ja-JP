...
* 複数のウィッシュリストのサポートを追加。 GraphQLを使用して、ウィッシュリストを [ 作成 ](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-wishlist.html)、[ 削除 ](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-wishlist.html) および [ 名前変更 ](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-wishlist.html) したり、ウィッシュリスト間でアイテムを [ 移動 ](https://developer.adobe.com/commerce/webapi/graphql/mutations/move-products-between-wishlists.html) または [ コピー ](https://developer.adobe.com/commerce/webapi/graphql/mutations/copy-products-between-wishlists.html) したりできます。<!-- MC-32356-->

* 返品承認（RMA）のサポートを追加しました。 買い物客は [ 返品をリクエスト ](https://developer.adobe.com/commerce/webapi/graphql/mutations/request-return.html) できます。 マーチャントがリクエストを受け入れると、買い物客は [ コメントの追加 ](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-return-comment.html) および [ トラッキング情報の追加 ](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-return-tracking.html) などのタスクを実行できます。<!-- MC-34596-->

* 次の B2B 機能がサポートされるようになりました。
   * 会社。 会社 [ 管理者 ](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company.html)、[ ユーザー ](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-user.html)、[ 役割 ](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-role.html)、[ チーム ](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-company-team.html) を追加できます。<!-- MC-33861-->
   * 会社クレジット。 [ 会社クエリ ](https://developer.adobe.com/commerce/webapi/graphql/queries/company.html) には、会社のクレジット履歴に関する詳細が含まれます。<!-- MC-33862-->
   * 購買依頼リスト。 購買依頼リストを [ 作成 ](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-requisition-list.html)、[ 削除 ](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-requisition-list.html) および [ 更新 ](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-requisition-list.html) できます。 サポートには、購買依頼リスト内の品目 [ 追加 ](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-requisition-list.html)、[ 更新 ](https://developer.adobe.com/commerce/webapi/graphql/mutations/update-products-in-wishlist.html)、[ 削除 ](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-requisition-list-items.html)、[ コピー ](https://developer.adobe.com/commerce/webapi/graphql/mutations/copy-items-between-requisition-lists.html)、[ 移動 ](https://developer.adobe.com/commerce/webapi/graphql/mutations/move-items-between-requisition-lists.html) および購買依頼リスト品目 [ 買い物かごに ](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-requisition-list-items-to-cart.html) を追加する機能も含まれています。<!-- MC-34312-->

* GraphQLでの和集合のサポートを追加しました。 [GitHub-29425](https://github.com/magento/magento2/issues/29425) <!-- ENGCOM-8291 -->

* [ 比較リスト ](https://developer.adobe.com/commerce/webapi/graphql/queries/compare-list.html) のサポートを追加しました。 買い物客は、比較リストを [ 作成 ](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-compare-list.html) および [ 削除 ](https://developer.adobe.com/commerce/webapi/graphql/mutations/delete-compare-list.html) したり、比較リストに項目を [ 追加 ](https://developer.adobe.com/commerce/webapi/graphql/mutations/add-products-to-compare-list.html) および [ 削除 ](https://developer.adobe.com/commerce/webapi/graphql/mutations/remove-products-from-compare-list.html) したりできます。 さらに、ゲストとして比較リストを作成した買い物客は、顧客としてログインし、比較リストを [ 保持 ](https://developer.adobe.com/commerce/webapi/graphql/mutations/assign-compare-list-to-customer.html) できます。

* リモート購入の支援をサポートするために、[`generateCustomerTokenAsAdmin`](https://developer.adobe.com/commerce/webapi/graphql/mutations/generate-customer-token-as-admin.html) のミューテーションを追加し、`Customer` オブジェクトを更新しました。
...
* 製品がステージングされているかどうかを判断し、関連するキャンペーン情報を表示するために、[`ProductInterface`](https://developer.adobe.com/commerce/webapi/graphql/interfaces/product-interface.html) と [`CategoryInterface`](https://developer.adobe.com/commerce/webapi/graphql/interfaces/category-interface.html) に `staging` 属性を追加しました。<!-- MC-33897-->
