...
* 提供終了に達した Zend フレームワーク （ZF1） コンポーネントは、コードベースから削除されました。 [ 後方互換性のない変更のハイライト ](https://developer.adobe.com/commerce/php/development/backward-incompatible-changes/highlights/) を参照してください。<!-- AC-1512 -->
