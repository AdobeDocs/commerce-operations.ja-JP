...
* 発注ルールGraphQLスキーマには、承認ルールを作成、編集および削除する機能と、発注書を手動で検証する機能があります。
...
* の値 **[!UICONTROL Allow Multiple Boxes for Shipping]** Advanced Inventory の製品の属性が期待どおりに保存されるようになりました。
