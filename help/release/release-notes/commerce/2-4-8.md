...
<table style="table-layout:auto">
    <tbody>
        ...
        <tr>
            ...
            <td>混乱を最小限に抑えるために、[!UICONTROL Submit Comment] 注文詳細 [!UICONTROL Update] ページで <a href="https://experienceleague.adobe.com/ja/docs/commerce-admin/stores-sales/order-management/orders/order-processing#notes-for-this-order"> ボタンのラベルが </a> に変更されました。</td>
        </tr>
    </tbody>
</table>
        ...
        <tr>
           ...
           <td>このリリースには、次のユーザー受注管理の機能拡張が含まれています。
             <ul>
              ...
              <li><!--LYNX-642--><code>order.availableActions</code> フィールドを更新して、マーチャントが管理者で並べ替え機能を <code>REORDER</code> 無効 <a href="https://experienceleague.adobe.com/ja/docs/commerce-admin/stores-sales/shopper-tools/reorders-allow#configure-to-allow-customer-reorders"> にした場合に </a> アクションが返されないようにします。</li>
