...
<table style="table-layout:auto">
    <tbody>
        ...
        <tr>
            ...
            <td>混乱を最小限に抑えるために、[!UICONTROL Submit Comment] 注文詳細 [!UICONTROL Update] ページで <a href="https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/order-management/orders/order-processing#notes-for-this-order"> ボタンのラベルが </a> に変更されました。</td>
        </tr>
    </tbody>
</table>
...
<table style="table-layout:auto">
    <tbody>
        ...
        <td>
            <ul>
              ...
              <li><!--LYNX-451--><code>grand_total_excluding_tax</code> タイプに「<a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-CartPrices"><code>CartPrices</code></a>」フィールドを追加し、明確な税を含む価格を提供しました。</li>
        ...
        <tr>
           ...
           <td>このリリースには、次のユーザー受注管理の機能拡張が含まれています。
             <ul>
              ...
              <li><!--LYNX-470--><code>date_of_first_order</code> タイプに新しい <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-CustomerOrders"><code>CustomerOrders</code></a> フィールドを追加しました。</li>
              ...
              <li><!--LYNX-449--><code>OrderItemPrices</code> に類似した <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-CartItemPrices"><code>CartItemPrices</code></a> タイプを追加し、<a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-OrderItemInterface"><code>OrderItemInterface</code></a> にいくつかの新しいフィールドを追加して価格を設定しました。</li>
              ...
              <li><!-- LYNX-524 --><code>customer_info</code> タイプに「<a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-CustomerOrder"><code>CustomerOrder</code></a>」フィールドを追加しました。 このフィールドには、顧客名の詳細を含む <code>OrderCustomerInfo</code> タイプが必要です。</li>
              ...
              <li><!--LYNX-642--><code>order.availableActions</code> フィールドを更新して、マーチャントが管理者で並べ替え機能を <code>REORDER</code> 無効 <a href="https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/shopper-tools/reorders-allow#configure-to-allow-customer-reorders"> にした場合に </a> アクションが返されないようにします。</li>
              <li><!--LYNX-598-->一部の国では郵便番号がオプションと見なされているので、<a href="https://developer.adobe.com/commerce/webapi/graphql/schema/orders/queries/guest-order/"><code>guestOrder</code></a> の代わりに <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/orders/queries/guest-order-by-token/"><code>guestOrderByToken</code></a> を使用するように <code>lastname</code> と <code>postcode</code> のクエリを更新しました。 その結果、一部のゲストユーザーは、注文処理中にトークンを取得したり、トークンを使用して注文を取得したりすると、問題が発生していました。</li>
              <li><!--LYNX-568-->登録されたお客様のみがアクセスできるように <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/orders/mutations/cancel-order/"><code>cancelOrder</code></a> のミューテーションを更新しました。 注文トークン（<code>requestGuestOrderCancel</code> 入力と同様）を必要とする新しい <code>guestOrderByToken</code> ールのバリエーションを追加しました。</li>
              <li><!--LYNX-551-->注文ステータスが変更された日付を追跡するための <code>order_status_change_date</code> フィールドを追加しました。</li>
              <li><!--LYNX-524--><code>OrderCustomerInfo</code> タイプに <code>CustomerOrder</code> を追加しました。</li>
              ...
              <li><!--LYNX-470--><code>created_at</code> フィールドと <code>date_of_first_order</code> タイプの公開済み <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-CustomerOrders"><code>CustomerOrders</code></a> ィールドに基づいて、注文履歴フィルターを追加しました。</li>
              <li><!--LYNX-450--><code>is_virtual</code> タイプと同様に、「<a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-CustomerOrder"><code>CustomerOrder</code></a>」フィールドを <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-Cart"><code>Cart</code></a> タイプに追加しました。 これにより、顧客は、仮想製品のみを含む注文の発送情報を条件付きで非表示にできます。</li>
        ...
        <td>
            <ul>
              <li><!--LYNX-540-->在庫レベルの詳細を提供するために、<code>quantity</code> に「<a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-ProductInterface"><code>ProductInterface</code></a>」フィールドを追加しました。 利用可能な在庫が表示されるか、管理設定に基づいて null が表示されます。</li>
    ...
    <tr>
        ...
        <td>
            <ul>
              ...
              <li><!--LYNX-695-->文字列ではなく price オブジェクトを返す <a href="https://developer.adobe.com/commerce/webapi/graphql/schema/store/queries/store-config/"><code>storeConfig</code></a> を含むように <code>printed_card_priceV2</code> クエリを更新しました。</li>
              ...
              <li><!--LYNX-693--><code>gift_message</code> タイプに <code>gift_wrapping</code> フィールドと <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#definition-GiftCardItem"><code>GiftCardCartItem</code></a> フィールドを追加しました。バーチャル製品のギフトラッピングを破棄するようにロジックを更新しました。</li>
              ...
              <li><!--LYNX-691--><a href="https://developer.adobe.com/commerce/webapi/graphql/schema/customer/queries/orders/"><code>customerOrders</code></a> フィールドを含むように <code>applied_gift_cards</code> クエリを更新し、<code>applied_coupons</code> に類似した適用されたギフトカードデータを取得できるようになりました。</li>
            </ul>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>
            <ul>
                <li><!--LYNX-522--><code>theme</code> クエリに <a href="https://developer.adobe.com/commerce/webapi/graphql-api/index.html#query-recaptchaV3Config"><code>recaptchaV3Config</code></a> フィールドを追加しました。 このフィールドを使用すると、reCaptcha のレンダリングに使用するテーマの名前を指定して、正確な価格と通貨の情報を確保できます。</li>
