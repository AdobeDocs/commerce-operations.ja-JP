...
* [Klarna の支払い方法 ](https://developer.adobe.com/commerce/webapi/graphql/payment-methods/klarna.html) の Klarna GraphQLに関するトピックを追加または更新しました [`createKlarnaPaymentsSession`](https://developer.adobe.com/commerce/webapi/graphql/mutations/create-klarna-payments-session.html)
