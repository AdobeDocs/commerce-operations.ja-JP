...
* GraphQL パスワードのリセット操作中にでエラーが発生した場合、より有益なメッセージがアプリケーションで返されるようになりました。 [GitHub-30179](https://github.com/magento/magento2/issues/30179)

<!-- MC-38078-->

* クエリ結果がキャッシュされた際に、GraphQL クエリの結果で、製品の位置が期待どおりに更新されるようになりました。
