...
user-guide-description: Adobe Commerceのプロジェクトを安全に管理するための規制コンプライアンスと加盟店の責任について説明します。
feature: Security
...
- 参照 {#reference}
   - [お客様の個人情報（バージョン 2.x）](privacy/data-m2.md)
   - [お客様の個人情報（バージョン 1.x）](privacy/data-m1.md)
