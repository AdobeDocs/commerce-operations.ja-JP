...
管理対象アラートに設定されているアラートしきい値は、New Relic アカウントから確認できます。 手順については、[&#x200B; 管理アラートによるパフォーマンスの監視 &#x200B;](https://experienceleague.adobe.com/ja/docs/commerce-on-cloud/user-guide/monitor/new-relic/investigate/investigate-performance#monitor-performance-with-managed-alerts) を参照してください。
