...
ACSD-47559 パッチは、電子メールテンプレートのプレビューが完全に表示されない問題を修正します。 このパッチは、[[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/announcements/commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.html?lang=ja) 1.1.24がインストールされている場合に利用できます。 パッチ IDはACSD-47559です。 この問題は、Adobe Commerce 2.4.6で修正される予定です。
