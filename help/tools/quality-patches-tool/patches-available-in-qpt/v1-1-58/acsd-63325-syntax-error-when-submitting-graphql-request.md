...
* Cloud Infrastructure上のAdobe Commerce:「[&#x200B; アップグレードとパッチ > Commerce Cloud Infrastructure ガイドのパッチを適用](https://experienceleague.adobe.com/en/docs/commerce-on-cloud/user-guide/develop/upgrade/apply-patches)」。
