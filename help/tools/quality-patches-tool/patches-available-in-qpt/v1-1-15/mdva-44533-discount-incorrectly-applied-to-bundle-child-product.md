...
MDVA-44533 パッチは、バンドルされた子製品に誤って割引が適用される問題を修正します。 このパッチは、[品質パッチツール（QPT） &#x200B;](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.15がインストールされている場合に使用できます。 パッチ IDはMDVA-44533です。 この問題は、Adobe Commerce 2.4.5で修正される予定です。
