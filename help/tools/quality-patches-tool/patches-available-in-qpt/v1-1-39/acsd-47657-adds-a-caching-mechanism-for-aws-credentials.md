...
ACSD-47657 パッチは、AWS資格情報のキャッシュメカニズムを追加することで、AWS S3へのリクエストの高負荷時に発生する問題を修正します。 このパッチは、[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.39がインストールされている場合に利用できます。 パッチ IDはACSD-47657です。 この問題は、Adobe Commerce 2.4.7で修正される予定です。
