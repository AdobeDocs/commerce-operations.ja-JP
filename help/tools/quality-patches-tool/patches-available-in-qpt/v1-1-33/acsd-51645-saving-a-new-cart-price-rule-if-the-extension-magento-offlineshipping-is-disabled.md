...
ACSD-51645 パッチでは、拡張機能のMagento_OfflineShippingが無効になっている場合に、新しい買い物かごの価格規則を保存する際にエラーが発生する問題を修正します。 このパッチは、[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.33がインストールされている場合に利用できます。 パッチ IDはACSD-51645です。 この問題は、Adobe Commerce 2.4.7で修正される予定です。
