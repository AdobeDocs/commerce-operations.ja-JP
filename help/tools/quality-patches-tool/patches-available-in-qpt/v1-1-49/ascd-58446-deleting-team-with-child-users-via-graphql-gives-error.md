...
ACSD-58446 パッチでは、GraphQLを介して子ユーザーまたはグループを持つチームを削除すると、UIと一致しない情報のないエラーメッセージが返されるAdobe Commerceの問題を修正します。 このパッチは、[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.49がインストールされている場合に利用できます。 パッチ IDはACSD-58446です。 この問題は、Adobe Commerce B2B 1.5.1で修正される予定です。
