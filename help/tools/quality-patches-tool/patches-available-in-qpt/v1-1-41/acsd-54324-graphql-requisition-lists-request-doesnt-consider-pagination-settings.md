...
1. フロントエンドにログインし、トップメニューまたは **[!UICONTROL My Requisition Lists]** から **[!UICONTROL My Account]** に移動し、複数の購買依頼を作成します（例：7）。
...
`total_count` ページサイズ *が記載されている場合でも、レコードの合計数は* 下に返されます。
