...
1. **ACSD-67171**：セッションの有効期限が切れたか、チェックアウト時にセッションが削除された場合に、[!DNL B2B] ユーザーにアクセス拒否ページが表示される問題を修正しました。
...
1. **ACSD-68391**：カテゴリ関連の権限が **[!UICONTROL Quick Order]** および **[!UICONTROL Requisition Lists]** で適用されない。
