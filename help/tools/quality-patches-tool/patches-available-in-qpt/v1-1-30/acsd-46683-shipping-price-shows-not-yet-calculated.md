...
ACSD-46683 パッチは、送料に「*まだ計算されていません*」と表示される問題を修正します。 このパッチは、[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.30がインストールされている場合に利用できます。 パッチ IDはACSD-46683です。 この問題は、Adobe Commerce 2.4.7で修正される予定です。
