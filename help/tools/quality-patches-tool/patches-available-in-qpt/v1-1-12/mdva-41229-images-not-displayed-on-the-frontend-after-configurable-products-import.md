...
description: MDVA-41229 パッチは、設定可能な製品のインポート後に、バックエンドで使用可能な画像がフロントエンドに表示されない問題を解決します。 このパッチは、[Quality Patches Tool （QPT） ] （https://experienceleague.adobe.com/ja/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches） 1.1.12がインストールされている場合に利用できます。 パッチ IDはMDVA-41229です。 この問題は、Adobe Commerce 2.4.5で修正される予定です。
