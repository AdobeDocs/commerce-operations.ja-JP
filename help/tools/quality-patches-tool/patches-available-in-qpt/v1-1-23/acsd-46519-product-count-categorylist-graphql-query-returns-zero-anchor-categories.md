---
title: 'ACSD-46519: [!UICONTROL product_count]query の [!UICONTROL categoryList] [!DNL GraphQL]  は、アンカーカテゴリの 0 を返します'
...
# ACSD-46519:[!UICONTROL product_count] クエリの [!UICONTROL categoryList] は、アンカーカテゴリ [!DNL GraphQL] 対して 0 を返します

ACSD-46519 パッチを使用すると、[!UICONTROL product_count] クエリの [!UICONTROL categoryList] がアンカーカテゴリ [!DNL GraphQL] 対して 0 を返す問題を解決できます。 このパッチは、[[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/ja/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches) 1.1.23 がインストールされている場合に使用できます。 パッチ ID は ACSD-46519 です。 この問題はAdobe Commerce 2.4.6 で修正される予定であることに注意してください。
