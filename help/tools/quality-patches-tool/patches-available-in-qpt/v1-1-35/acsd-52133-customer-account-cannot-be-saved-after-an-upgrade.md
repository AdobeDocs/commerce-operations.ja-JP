...
>[!NOTE]
>
>このパッチは、セキュリティパッチ [APSB25-08](https://experienceleague.adobe.com/en/docs/commerce-knowledge-base/kb/troubleshooting/known-issues-patches-attached/security-update-available-for-adobe-commerce-apsb25-08)との競合により非推奨（廃止予定）になりました。
