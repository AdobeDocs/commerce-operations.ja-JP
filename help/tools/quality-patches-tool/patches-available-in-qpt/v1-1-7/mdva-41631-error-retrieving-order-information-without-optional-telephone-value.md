...
MDVA-41631 パッチは、オプションの「telephone」値を指定せずに[!DNL GraphQL]経由で注文情報を取得する際にユーザーがエラーを受け取る問題を修正します。 このパッチは、[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.7がインストールされている場合に利用できます。 この問題は、Adobe Commerce 2.4.4で修正される予定です。
