...
description: MDVA-42509 パッチは、CSVを迅速な注文のためにアップロードできなかった場合、「Cookieを送信できません」エラーが発生する問題を解決します。 このパッチは、[Quality Patches Tool （QPT） ] （https://experienceleague.adobe.com/ja/docs/commerce-operations/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches） 1.1.16がインストールされている場合に利用できます。 パッチ IDはMDVA-42509です。 この問題は、Adobe Commerce 2.4.5で修正される予定です。
feature: B2B, Orders
role: Admin
