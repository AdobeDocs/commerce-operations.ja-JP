...
ACSD-54885 パッチは、管理者が&#x200B;*[!UICONTROL Login as Customer]*&#x200B;機能を使用しているときに複数のアドレス チェックアウト中にエラーが発生する問題を修正します。 このパッチは、[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.43がインストールされている場合に利用できます。 パッチ IDはACSD-54885です。 この問題は、Adobe Commerce 2.4.7で修正される予定です。
