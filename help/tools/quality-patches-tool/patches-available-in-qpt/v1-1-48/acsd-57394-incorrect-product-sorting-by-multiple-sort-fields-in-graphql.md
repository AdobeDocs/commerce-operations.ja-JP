...
ACSD-57394 パッチは、[!DNL GraphQL]で複数の並べ替え属性を使用する際に製品が正しく並べ替えられない問題を修正します。 このパッチは、[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.48がインストールされている場合に利用できます。 パッチ IDはACSD-57394です。 この問題は、Adobe Commerce 2.5.0で修正される予定です。
