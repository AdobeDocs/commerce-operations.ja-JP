...
ACSD-55566 パッチは、[!DNL GraphQL]応答の内部サーバーエラーで`mergeCart`の突然変異が失敗する問題を修正します。 このパッチは、[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.48がインストールされている場合に利用できます。 パッチ IDはACSD-55566です。 この問題は、Adobe Commerce 2.5.0で修正される予定です。
