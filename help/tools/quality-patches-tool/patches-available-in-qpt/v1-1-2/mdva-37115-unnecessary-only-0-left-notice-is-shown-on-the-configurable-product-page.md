...
description: MDVA-37115 パッチを適用すると、設定可能な製品ページに不要な*Only 0 left*通知が表示される問題が解決されます。 このパッチは、[Quality Patches Tool （QPT） ] （https://experienceleague.adobe.com/ja/docs/commerce-knowledge-base/kb/announcements/commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches） 1.1.2 がインストールされている場合に利用できます。 パッチ ID は MDVA-37115。 この問題はAdobe Commerce 2.4.3 で修正されました。
