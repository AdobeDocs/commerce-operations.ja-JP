...
ACSD-60631 パッチは、同じ製品が複数の設定可能な製品に割り当てられている場合にGraphQL クエリがエラーを返す問題を修正します。 このパッチは、[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.51がインストールされている場合に利用できます。 パッチ IDはACSD-60631です。 この問題は、Adobe Commerce 2.4.8で修正される予定です。
