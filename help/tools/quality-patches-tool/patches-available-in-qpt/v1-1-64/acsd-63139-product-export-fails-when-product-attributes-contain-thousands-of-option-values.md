...
1. [!DNL RabbitMQ] 前提条件 [[!DNL RabbitMQ]  の手順に従って、](https://experienceleague.adobe.com/ja/docs/commerce-operations/installation-guide/prerequisites/rabbitmq) を設定します。
