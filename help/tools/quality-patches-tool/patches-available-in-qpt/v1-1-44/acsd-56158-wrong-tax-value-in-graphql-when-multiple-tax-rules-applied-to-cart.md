...
ACSD-56158 パッチは、複数の税規則がカートに適用されている場合に、GraphQLの回答で税値のレンダリングが正しくない問題を修正します。 このパッチは、[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.44がインストールされている場合に利用できます。 パッチ IDはACSD-56158です。 この問題は、Adobe Commerce 2.4.7で修正される予定です。
