...
MDVA-42768 パッチでは、子商品の設定可能な商品が在庫切れになった場合に、GraphQLで誤った価格が表示される問題を修正します。 このパッチは、[品質パッチツール（QPT） &#x200B;](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.10がインストールされている場合に使用できます。 パッチ IDはMDVA-42768です。 この問題は、Adobe Commerce 2.4.5で修正される予定です。
