...
QPTで使用可能な他のパッチについて詳しくは、品質パッチツールガイドの「[[!DNL Quality Patches Tool]: パッチを検索](https://experienceleague.adobe.com/tools/commerce-quality-patches/index.html?lang=ja)」を参照してください。
