...
1. **ACSD-58131** 古いメディアギャラリーは、0 バイトの画像ファイルが原因で画像の読み込みに失敗します。
...
1. **ACSD-66233**：ポップアップが読み込まれないので、管理者ユーザーがカテゴリに製品 [!UICONTROL Add Product] 追加できませんでした。
...
1. **ACSD-66963**：仮想製品 `estimateTotals` 買い物かごに割引コードが適用された場合、割引に対してミューテーションが *null* を返します。
