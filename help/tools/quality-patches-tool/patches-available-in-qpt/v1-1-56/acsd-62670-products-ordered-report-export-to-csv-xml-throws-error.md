...
ACSD-62670 パッチは、*[!UICONTROL Ordered Products Report]*&#x200B;をCSVおよびXMLに書き出すとエラーが発生する問題を修正します。 このパッチは、[[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/docs/commerce-operations/tools/quality-patches-tool/usage.html) 1.1.56がインストールされている場合に利用できます。 パッチ IDはACSD-62670です。 この問題は、Adobe Commerce 2.4.8で修正される予定です。
