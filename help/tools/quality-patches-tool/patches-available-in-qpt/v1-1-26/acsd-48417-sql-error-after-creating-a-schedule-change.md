...
ACSD-48417 パッチは、製品のスケジュール変更を作成し、別の製品を保存した後にSQL エラーが表示される問題を修正します。 このパッチは、[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.26がインストールされている場合に利用できます。 パッチ IDはACSD-48417です。 この問題は、Adobe Commerce 2.4.7で修正される予定です。
