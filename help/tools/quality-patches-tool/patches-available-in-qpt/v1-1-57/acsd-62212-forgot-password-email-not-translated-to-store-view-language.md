...
ACSD-62212 パッチは、*[!UICONTROL Forgot Password]*&#x200B;電子メールのコンテンツがストアビュー言語に翻訳されない問題を修正します。 このパッチは、[[!DNL Quality Patches Tool (QPT)]](https://experienceleague.adobe.com/docs/commerce-operations/tools/quality-patches-tool/usage.html) 1.1.57がインストールされている場合に利用できます。 パッチ IDはACSD-62212です。 この問題は、Adobe Commerce 2.4.8で修正される予定です。
