...
QPT で使用可能なその他のパッチの詳細については、[ ガイドの ](https://experienceleague.adobe.com/tools/commerce-quality-patches/index.html)QPT で使用可能なパッチ [!DNL Quality Patches Tool] を参照してください。
