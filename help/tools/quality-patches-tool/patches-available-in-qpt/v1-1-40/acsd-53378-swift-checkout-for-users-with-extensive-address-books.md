...
ACSD-53378 パッチは、大きな顧客アドレスボリュームが原因でパフォーマンスの問題が発生する問題を修正します。 このパッチは、[[!DNL Quality Patches Tool (QPT)]](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.40がインストールされている場合に利用できます。 パッチ IDはACSD-53378です。 この問題は、Adobe Commerce 2.4.7で修正される予定です。
