...
MDVA-38666 パッチは、管理者ユーザーが顧客のカート内の設定可能な製品オプションを変更できない問題を解決します。 このパッチは、[品質パッチツール （QPT） &#x200B;](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.9がインストールされている場合に使用できます。 パッチ IDはMDVA-38666です。 この問題は、Adobe Commerce 2.4.5で修正される予定です。
