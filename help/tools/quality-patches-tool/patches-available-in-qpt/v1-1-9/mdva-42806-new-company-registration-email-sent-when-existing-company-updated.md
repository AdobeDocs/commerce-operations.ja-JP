...
MDVA-42806 パッチは、既存の会社がREST APIを介して更新されるたびに、新規会社登録メールが送信される問題を解決します。 このパッチは、[品質パッチツール （QPT） ](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.9がインストールされている場合に使用できます。 パッチ IDはMDVA-42806です。 この問題は、Adobe Commerce 2.4.5で修正される予定です。
