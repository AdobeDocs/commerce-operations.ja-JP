...
MDVA-38626 パッチは、管理者ユーザーがPayPal Payflow Pro支払い方法を使用してバックエンドで注文できない問題を解決します。 このパッチは、[品質パッチツール （QPT） &#x200B;](/help/tools/quality-patches-tool/quality-patches-tool-to-self-serve-quality-patches.md) 1.1.9がインストールされている場合に使用できます。 パッチ IDはMDVA-38626です。 この問題は、Adobe Commerce 2.4.5で修正される予定です。
