...
アドビでは、Magento 2 でMagento 1 拡張機能を使用するお客様を支援するために、開発コミュニティと協力して取り組んでいます。 お気に入りの拡張機能の最新版をダウンロードまたは購入できる [Commerce Marketplace](https://commercemarketplace.adobe.com//) を紹介します。
