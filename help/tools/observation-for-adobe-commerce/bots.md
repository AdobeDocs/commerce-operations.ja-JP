...
この **[!UICONTROL Rate of HTTP request per second (top 25) during requested time period]** frame は、選択した期間における 1 秒あたりの最大リクエスト数を示します。 これらのアドレスも上記の表にある場合は、CDN アドレスではなく、悪意のあるアドレスであることを確認し、 [!DNL Fastly].
