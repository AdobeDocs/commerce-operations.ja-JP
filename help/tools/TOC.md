...
- 品質向上パッチツール {#quality-patches-tool}
   ...
   - 品質向上パッチツールで使用可能なパッチ {#patches-available-in-qpt}
      ...
      - v1.1.50 {#v1-1-50}
         ...
         - [ACSD-46938：設定中の DB トリガーのパフォーマンスの問題](quality-patches-tool/patches-available-in-qpt/v1-1-50/acsd-46938-fix-for-db-triggers-performance-issue-during-setup-upgrade.md)
      ...
      - v1.1.55 {#v1-1-55}
         ...
         - [ACSD-61534: bin/magento 設定を使用してデザイン設定を設定することはできません](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-55/acsd-61534-design-configuration-cannot-set-using-bin-magento-config-set.md)
      ...
      - v1.1.65 {#v1-1-65}
         ...
         - [ACSD-64118：同じ製品に対する同時の製品保存リクエストにより、データの不整合とエントリの重複が発生する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-65/acsd-64118-concurrent-product-save-requests-for-same-product-cause-data-inconsistency-and-duplicate-entries.md)
         ...
         - [ACSD-65331：チェックアウトに戻った後、[!UICONTROL Pick in Store] で選択されたストアがクリアされました](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-65/acsd-65331-selected-store-in-pick-in-store-cleared-after-returning-to-checkout-page.md)
      - v1.1.66 {#v1-1-66}
         - [概要： [!DNL Quality Patches Tool]  （QPT） v1.1.66](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-66/overview.md)
         - [ACSD-66041：国 ID がないため、アイルランド （IE）の郵便番号で集荷場所を検索できません](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-66/acsd-66041-ireland-ie-postcodes-were-not-searchable-for-pickup-locations-due-to-a-missing-countryid.md)
         - [ACSD-65913: [!DNL OpenSearch]  同じ価格の製品を含むカテゴリに対して illegal_argument_exception をスローする](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-66/acsd-65913-opensearch-threw-an-illegal-argument-exception-for-categories-with-products-having-the-same-price.md)
         - [ACSD-65848：管理画面のカテゴリの読み込みに時間がかかる](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-66/acsd-65848-categories-in-admin-are-loading-very-slow.md)
         - [ACSD-65750: [!DNL GraphQL] &quot;route&quot; クエリは、商品が順不同である in [!DNL Page Builder] Products コンテンツ タイプを返します](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-66/acsd-65750-graphql-route-query-returned-products-out-of-order-in-page-builder-products-content-types.md)
         - [ACSD-65777:MediaGallery GraphQL リクエストに商品の画像タイプの「タイプ」フィールドがない](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-66/acsd-65777-types-field-was-missing-for-product-image-types-in-the-mediagallery-graphql-request.md)
         - [ACSD-66212：顧客の CSV ファイルを 2 回インポートすると、2 回目以降の試行でエラーが発生しました](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-66/acsd-66212-importing-a-customer-csv-file-twice-caused-failures-on-the-second-and-subsequent-attempts.md)
         - [ACSD-65775：複数の数量に対する REST API オーダー詳細の base_row_total と row_total の値が正しくありません](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-66/acsd-65775-incorrect-order-detail-values-in-rest-api-order-details-for-multiple-quantities.md)
         ...
         - [ACP2E-3918：店舗での受け取りを使用している会社の顧客のチェックアウト エラー](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-66/acp2e-3918-checkout-failure-for-company-customers-using-in-store-pickup.md)
      - v1.1.67 {#v1-1-67}
         - [概要： [!DNL Quality Patches Tool]  （QPT） v1.1.67](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-67/overview.md)
         - [ACSD-65935：商品が削除されたときに、customerOrders GraphQL クエリが内部サーバーエラーを返しました](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-67/acsd-65935-customerorders-graphql-query-returned-an-internal-server-error-when-a-product-was-deleted.md)
         - [ACSD-66139：非アクティブな買い物かごに対してGraphQLの注文が失敗し、UNDEFINED エラーが発生する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-67/acsd-66139-graphql-order-fails-with-undefined-error-for-inactive-cart.md)
         - [ACSD-66301:Commerce管理で注文から買い物かごに商品を移動すると、数量が一致しない](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-67/acsd-66301-order-to-cart-quantity-mismatch.md)
         - [AC-14984: php-amqplib/php-amqplib ^3.2.0 での SSL 接続の問題](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-67/ac-14984-ssl-connection-issue-with-php-amqplib-php-amqplib-3-2.md)
         - [ACSD-66118：構成キャッシュが更新されない場合、[!UICONTROL Store View] コード [!UICONTROL Design Configuration] 更新すると設定がクリアされます](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-67/acsd-66118-updating-store-view-code-clears-design-configuration-settings-if-configuration-cache-isn-t-refreshed.md)
         - [ACSD-66084: row_total_incl_tax は、注文 API で完全に割引された項目に対して 0.00 ではなく、ゼロに近い値を返します](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-67/acsd-66084-fix-row-total-incl-tax-residual-value-for-discounted-items-in-order-api.md)
         - [ACSD-66049：英語以外のストアフロントで、ICU ライブラリバージョンが原因で誤った価格が表示される](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-67/acsd-66049-non-english-storefronts-display-incorrect-pricing-due-to-the-icu-library-version.md)
         - [ACSD-66441：マルチストア設定で、レイヤーナビゲーションに間違った属性オプションが表示される](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-67/acsd-66441-layered-navigation-displays-incorrect-attribute-in-multi-store-setup.md)
         - [AC-14985:TLS を使用して SMTP メールを送信する際にエラーが発生する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-67/ac-14985-error-when-sending-smtp-emails-using-tls.md)
         - [ACSD-66434:company[!UICONTROL Customer ID]queries に  [!DNL GraphQL]  がありません](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-67/acsd-66434-customer-id-missing-from-company-graphql-queries.md)
      - v1.1.68 {#v1-1-68}
         ...
         - [ACSD-58131:0 バイトの画像ファイルが原因で、古いメディアギャラリーが画像の読み込みに失敗する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-68/acsd-58131-old-media-gallery-fails-to-load-images-due-to-0-byte-image-file.md)
         - [ACSD-66963:estimateTotals ミューテーションが、仮想製品の割引に対して null を返す](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-68/acsd-66963-estimatetotals-mutation-returns-null-for-discounts-on-virtual-products.md)
         - [ACSD-66506：共有カタログ製品を削除して再割り当てした後に、バックエンドエラーが発生する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-68/acsd-66506-backend-error-occurs-after-deleting-and-reassigning-shared-catalog-products.md)
         - [ACSD-66889: CLI でインベントリの再インデックス中にエラーが発生しました](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-68/acsd-66889-error-during-inventory-reindex-in-cli.md)
         ...
         - [ACSD-62146：選択した請求先住所がチェックアウトの支払いページに表示されない](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-68/acsd-62146-selected-billing-address-disappears-on-checkout-payment-page.md)
         - [ACSD-67039: rp_token システム属性の検証により、顧客レコードが保存されませんでした](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-68/acsd-67039-customer-records-were-not-saved-due-to-validation-of-the-rp-token-system-attribute.md)
         - [ACSD-66179:[!UICONTROL Not Capture] 支払タイプの請求書を取り消すと、404 エラーページが表示される](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-68/acsd-66179-canceling-an-invoice-with-the-not-capture-payment-type-results-in-a-404-error-page.md)
         - [ACSD-66082：製品の読み込みから製品のスウォッチ画像を更新できない](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-68/acsd-66082-cant-update-a-products-swatch-image-through-product-import.md)
         - [ACSD-66233：製品リストポップアップが応答しないため、管理者が製品を追加できない](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-68/acsd-66233-admins-unable-add-products-due-to-unresponsive-product-list-popup.md)
      - v1.1.69 {#v1-1-69}
         - [概要： [!DNL Quality Patches Tool]  （QPT） v1.1.69](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-69/overview.md)
         - [ACSD-66302:web サイトではなくストア ID でフィルターされたウィッシュリスト項目](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-69/acsd-66302-wishlist-items-filtered-by-store-id-instead-of-website.md)
         - [ACSD-58108：結合テーブル名がないために、SQL エラーが順序グリッドのカスタムモジュール拡張で発生します](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-69/acsd-58108-missing-join-table-name-causes-sql-errors-in-order-grid-custom-module-extension.md)
         - [ACP2E-3767：バンドル製品を保存すると、最後のバンドルオプションが再び表示される](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-69/acp2e-3767-last-bundle-option-reappears-after-saving-a-bundle-product.md)
         - [ACP2E-4050：複数出荷チェックアウトでは適用されませ [!UICONTROL Free Shipping]](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-69/acp2e-4050-cart-price-rules-fail-for-multi-shipping-with-bundle-products-and-free-shipping.md)
         - [ACSD-66311：制限付き管理者の会社グリッドの読み込みに時間がかかる](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-69/acsd-66311-companies-grid-loads-slowly-for-restricted-admins.md)
         - [ACSD-67347：クーポンコード使用時に「ロックを取得できません」エラーが発生して注文が失敗する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-69/acsd-67347-order-fails-with-lock-error-when-using-special-character-coupons-and-file-locking.md)
         - [ACP2E-3731：表示が [!UICONTROL Catalog, Search] い製品の書き出しには、他のストア表示のレコードが含まれます](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-69/acp2e-3731-product-exports-with-catalog-search-visibility-include-records-from-other-store-views.md)
         - [ACSD-66153：間違ったレイアウト構造がキャッシュされているので、ページが 500 を返す](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-69/acsd-66153-page-returns-500-due-to-incorrect-layout-structure-being-cached.md)
         - [ACSD-57477：販売ルールの処理により、買い物かごに関連するリクエストのパフォーマンスが低下する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-69/acsd-57477-sales-rule-processing-slows-performance-on-cart-related-requests.md)
         - [ACSD-65983：管理者でバンドルされた製品見積もりを再設定するとエラーが発生する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-69/acsd-65983-error-occurs-when-reconfiguring-bundled-product-quote-in-admin.md)
         - [ACP2E-3964:REST API 経由でリストされないビデオを含む、設定可能な子製品](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-69/acp2e-3964-configurable-child-products-with-video-not-listed-via-rest-api.md)
         - [ACP2E-3977: [!UICONTROL Cap Reward Points Balance At] フィールドを空白にすることはできません](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-69/acp2e-3977-cap-reward-points-balance-at-cannot-be-left-empty.md)
         - [ACSD-56226：読み取りクエリは、synchronous_replication が有効な古いデータを返します](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-69/acsd-56226-read-queries-return-outdated-data-with-synchronous-replication-enabled.md)
         - [ACSD-66149: IPN ハンドラーは、サポートされていない型に対して 500 を返します](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-69/acsd-66149-ipn-handler-returns-500-for-unsupported-types.md)
         - [ACSD-66952：ターゲットルールが設定されると、PLP または買い物かごへの訪問ごとにキャッシュがクリアされる](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-69/acsd-66952-cache-clears-on-each-plp-or-cart-visit-when-a-target-rule-is-set.md)
         - [ACSD-67264：バンドルおよびダウンロード可能な製品ページレイアウトがデバイス間で一貫していない](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-69/acsd-67264-bundle-and-downloadable-product-page-layouts-inconsistent-across-devices.md)
         - [ACSD-66404:Galera クラスタのトランザクション・サイズ制限により、Cron ジョブが変更ログ・テーブルのクリアに失敗する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-69/acsd-66404-cron-job-fails-to-clear-changelog-tables-due-to-galera-cluster-transaction-size-limits.md)
         - [AC-15223：ストアフロントページで、ストアの切り替え後にキャッシュされたコンテンツが表示される](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-69/ac-15223-storefront-page-shows-cached-content-after-switching-stores.md)
      - v1.1.70 {#v1-1-70}
         - [概要： [!DNL Quality Patches Tool]  （QPT） v1.1.70](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-70/overview.md)
         - [ACSD-67030：限られた役割管理者によって設定可能な製品が編集されると、単純な製品の割り当てが解除されます](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-70/acsd-67030.md)
         - [ACSD-67102：カテゴリや製品が多数ある場合、カテゴリの読み込みが遅くなったりタイムアウトしたりする](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-70/acsd-67102.md)
         - [ACSD-66120: [!DNL GraphQL]  カタログ価格に税が含まれている場合に、誤った割引率と基本価格が表示される](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-70/acsd-66120.md)
         - [ACSD-67289：特別価格が適用されると、通常価格が表示されない](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-70/acsd-67289.md)
         - [ACSD-67166：ストアフロントに見積もりを読み込む際に、cataloginventory_stock_status クエリが重複して実行されました](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-70/acsd-67166.md)
         - [ACSD-67659：翻訳済みエラーメッセージが未定義のエラーコードを返す](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-70/acsd-67659.md)
         - [ACSD-66157：異なるタイムゾーンで作成された web サイトには、特別価格は適用されません](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-70/acsd-66157.md)
         - [AC-15210:Web ツール API から新しい RESTful USPS API への USPS 統合の移行](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-70/ac-15210.md)
      - v1.1.71 {#v1-1-71}
         - [概要： [!DNL Quality Patches Tool]  （QPT） v1.1.71](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-71/overview.md)
         - [ACSD-67089:page_size が設定されている場合、inventory/export-stock-salable-qty API が誤った total_count を返す](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-71/acsd-67089.md)
         - [ACSD-67643：ネストの高いカテゴリ環境で、スケジュールされた更新時に重複エントリが作成される ](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-71/acsd-67643.md)
         - [ACSD-67603：画像を含めることが有効になっている製品のサイトマップ生成の処理時間が長い](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-71/acsd-67603.md)
         - [ACSD-67093：日付範囲フィルターを使用して、GraphQLから注文を取得すると、誤った結果が返される](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-71/acsd-67093.md)
         - [ACSD-67652:GraphQL呼び出しで、在庫切れとして返されるバンドル商品ステータス（商品が在庫の子商品および親商品を含む）](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-71/acsd-67652.md)
         - [ACSD-60624：の画像、バナー、スライダーの各セクションの空のコンテンツで、画像のアップロードに失敗する  [!DNL Page Builder]](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-71/acsd-60624.md)
         - [ACSD-67904：市区町村名に数字（0 ～ 9）、アンパサンド （&amp;）、ピリオド （.）、または括弧（）が含まれている場合、注文を行うことはできません ](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-71/acsd-67904.md)
         - [ACSD-67459：説明が 65,536 文字を超える製品をインポートできません](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-71/acsd-67459.md)
      - v1.1.72 {#v1-1-72}
         - [概要： [!DNL Quality Patches Tool]  （QPT） v1.1.72](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/overview.md)
         - [ACSD-67424:GET /carts/search REST API 応答の updated_at 値が、[!UICONTROL Admin Panel] の [!UICONTROL Negotiable Quotes] の値と一致しません](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-67424.md)
         - [ACSD-67383：同じセッションで 2 つの会社管理者アカウントを持つ顧客としてログインする際にエラーが発生する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-67383.md)
         - [ACSD-68064：深くネストされたカテゴリを含む環境のスケジュールされた更新中に、重複エントリが作成される](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-68064.md)
         - [ACSD-67946：買い物かごの更新で、重複したエラーバナーが表示される](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-67946.md)
         - [ACSD-68118: customerCart [!DNL GraphQL] query がストア表示の誤った製品属性値を返す](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-68118.md)
         - [ACSD-66807:report_viewed_product_index テーブルに、製品ページビューの誤った数が表示される](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-66807.md)
         - [ACSD-68040：大きな履歴で、フロントエンド検索ページの速度が  [!DNL MariaDB] 10.6 で低下する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-68040.md)
         - [ACSD-67639：動的価格が「No」に設定されているバンドル製品のクレジット・メモの作成が失敗する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-67639.md)
         - [ACSD-67518: [!DNL Advanced Reporting]  行数がバッチサイズを超えると、重複するヘッダー行が生成されます](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-67518.md)
         - [ACSD-67941：不明なフィルター名を持つGraphQL リクエストが原因で PHP 例外ログが発生する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-67941.md)
         - [ACSD-68011:/V1/sharedCatalog/を介して共有カタログに割り当てられた、存在しない SKU](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-68011.md)
         - [ACSD-68092：複数の保存後に、バンドル製品オプションが失われる](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-68092.md)
         - [ACSD-67187：デフォルト以外の web サイトに制限された管理者ユーザーに、「続行するには、少なくとも 1 つの公開共有カタログを作成してください」エラーが発生する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-67187.md)
         - [ACSD-67696：キャッシュのフラッシュ後、Cart GraphQLの商品ノードで media_gallery エントリが返されない](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-72/acsd-67696.md)
      - v1.1.73 {#v1-1-73}
         ...
         - [ACSD-68391:[!UICONTROL Quick Order] および [!UICONTROL Requisition Lists] でカテゴリ関連の権限が適用されない](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-73/acsd-68391.md)
         - [ACSD-67908：マルチストアの設定で、JavaScript ファイルが正しく結合されない](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-73/acsd-67908.md)
         - [レート制限と PHP Redis 拡張で ACSD-68206: [!DNL GraphQL] server が失敗する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-73/acsd-68206.md)
         - [ACSD-67171：チェックアウト中に期限切れのセッションが  [!DNL B2B]  ログインではなくアクセス拒否ページにリダイレクトされる](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-73/acsd-67171.md)
         - [ACSD-68400：仮想ギフトカードの数量が、在庫予約テーブルに正確に反映されない](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-73/acsd-68400.md)
         - [ACSD-68356: [!DNL GraphQL] cart クエリで、仮想引用符に対して誤った割引額が返される](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-73/acsd-68356.md)
      - v1.1.74 {#v1-1-74}
         - [概要： [!DNL Quality Patches Tool]  （QPT） v1.1.74](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-74/overview.md)
         - [ACSD-68499:GraphQL updateCartItems mutation で、使用可能な在庫を超える数量の成功が返される](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-74/acsd-68499.md)
         - [ACSD-68810：顧客アカウント共有設定にかかわらず、別の web サイトで作成された顧客に割り当てられた注文](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-74/acsd-68810.md)
         - [ACSD-68430：レコードに削除された属性オプションが複数含まれている場合、顧客またはアドレスの保存に失敗する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-74/acsd-68430.md)
         - [ACSD-68636：別のストアから請求書を作成する際に、ギフト カードの E メール ヘッダーにストア所有者名が表示されない](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-74/acsd-68636.md)
      - v1.1.75 {#v1-1-75}
         - [概要： [!DNL Quality Patches Tool]  （QPT） v1.1.75](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/overview.md)
         - [ACSD-68359：大きな買い物かごで [!UICONTROL Pick in Store] を選択する際の 414 エラーを修正しました](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68359.md)
         - [ACSD-68517:[!UICONTROL Catalog] ページと [!UICONTROL Catalog Search] ページのフォーム再送信エラーを修正します](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68517.md)
         - [ACSD-68573：カテゴリ権限が顧客のウィッシュリスト項目に適用されず、web ストアフロントとGraphQLで誤った表示とページネーションが発生していました](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68573.md)
         - [ACSD-68793：共有カタログの割り当て中に、有効な製品が誤って却下される](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68793.md)
         - [ACSD-68925:GraphQLの応答が HTTP 仕様に従い、解析不能な、認証されていない、または無効なリクエストに対して 4XX を返すようになりました](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68925.md)
         - [ACSD-68289：検索可能なすべてのフィールドに最小一致が適用される場合、フルテキスト検索で結果が返されない](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68289.md)
         - [ACSD-68451：会社管理者が、複数の web サイトをまたいで関連のない会社にリンクする](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68451.md)
         - [ACSD-68615：注文 ID がない場合の在庫予約報酬 CLI 例外](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68615.md)
         - [ACSD-68490：設定可能な製品の作成中に、制限付き管理者に表示される [!UICONTROL Add New Attribute] ボタン](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-75/acsd-68490.md)
      - v1.1.76 {#v1-1-76}
         - [概要： [!DNL Quality Patches Tool]  （QPT） v1.1.76](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/overview.md)
         - [ACSD-69203：カテゴリ条件で複数のカテゴリが使用されている場合、製品リストウィジェットが誤った結果を返す](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69203.md)
         - [ACSD-69115：デフォルト以外の web サイトに割り当てられた顧客の管理者ユーザーに、買い物かごのエラーが表示されない](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69115.md)
         - [ACSD-67370:PDP/PLP のバンドル製品と、複数通貨ストアの買い物かごページで誤った価格が表示されていました](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-67370.md)
         - [ACSD-69261：一部請求および取消フローでの times_used 処理が正しくないため再利用された、使い捨ての買い物かご価格ルールクーポン](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69261.md)
         - [ACSD-67091：大規模な削除中に書き込みセットの最大サイズが原因で、カタログルール製品インデックスのクリーンアップが失敗する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-67091.md)
         - [ACSD-69308:Web サイトレベルで「special_price」が設定されている場合、カタログ価格ルールが適用されない](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69308.md)
         - [ACSD-69541:ACSD-69541:[!UICONTROL Admin] で商品の在庫を減らした後で、GraphQLで買い物かごの商品数を更新できない](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69541.md)
         - [ACSD-69325:SKU ケースを変更すると、ストアフロントに製品の在庫切れが表示される](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69325.md)
         - [デフォルトのベース Web サイトを削除し、セカンダリ Web サイトをデフォルトとして使用すると、ACSD-69129: [!DNL REST] API 階層の価格の更新が失敗する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69129.md)
         - [ACSD-68410：交渉可能な見積もりチェックアウトに、意図しない買い物かご品目が含まれる](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-68410.md)
         - [ACSD-69333：スケジュールされたアクティブな更新を含む製品で許可される SKU 変更](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-76/acsd-69333.md)
      - v1.1.77 {#v1-1-77}
         - [概要： [!DNL Quality Patches Tool]  （QPT） v1.1.77](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/overview.md)
         - [ACSD-69237: sales_*_async_insert cron ジョブは、1 回の実行で 100 エントリしか処理しません](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-69237.md)
         - [ACSD-68759：ストアフロントに [!UICONTROL Date of Birth] が表示される場合、アラビア語（サウジアラビア）ロケールで顧客アカウントの作成が失敗する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-68759.md)
         - [ACSD-69016：タイムゾーンの異なる web サイトでは特別価格は適用されません](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-69016.md)
         - [ACSD-69351：間違った web サイトに表示されるギフトカードの残高と有効期限](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-69351.md)
         - [ACSD-69020：子製品がフィルターと一致すると、設定可能な製品がカルーセルに表示される  [!DNL Page Builder] ](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-69020.md)
         - [ACSD-68892：キャッシュ可能なページのキャッシュ動作  [!DNL Fastly]  一貫性がない](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-68892.md)
         - [ACSD-68664：スケジュールされた更新のプレビューで、カスタム ストア ドメインにエラーが発生しました](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-68664.md)
         - [ACSD-63687：キャッシュクリーンアップの問題により、誤った価格が表示され  [!DNL Redis]  す](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-63687.md)
         - [ACSD-69494: 「is_online」を含む非同期返金リクエストで、トリガーによるオンライン返金は行われません](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-69494.md)
         - [ACSD-68537：多くの顧客セグメントにより、チェックアウトのパフォーマンスが低下する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-68537.md)
         - [ACSD-69311：請求書から一部払戻した後のクレジット・メモの税金計算が正しくない](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-69311.md)
         - [ACSD-68341:PDP 読み込み時に、複数の X-Magento-Vary cookie の更新が発生する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-77/acsd-68341.md)
