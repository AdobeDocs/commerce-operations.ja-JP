...
- 品質向上パッチツール {#quality-patches-tool}
   ...
   - 品質向上パッチツールで使用可能なパッチ {#patches-available-in-qpt}
      ...
      - v1.1.73 {#v1-1-73}
         ...
         - [ACSD-68190：割引が適用されない、適用された割引がGraphQLの買い物かご表示の応答に正しく表示されない、クーポン以外の割引はクーポンの割引を削除する](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-73/acsd-68190.md)
         ...
         - [ACSD-68400：仮想ギフト カードの数量が在庫予約テーブルに正確に反映されませんでした](/help/tools/quality-patches-tool/patches-available-in-qpt/v1-1-73/acsd-68400.md)
