...
>[!NOTE]
>
>- Adobe Commerceのクラウドインフラプロジェクトでは、Fastly サービスに商品イメージのサイズ変更をオフロードできます。 _クラウドガイド_&#x200B;の[深層画像最適化](https://experienceleague.adobe.com/ja/docs/commerce-on-cloud/user-guide/cdn/fastly-image-optimization#deep-image-optimization)を参照してください。
