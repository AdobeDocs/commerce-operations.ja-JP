...
- ベストプラクティス {#best-practices}
   ...
   - 計画 {#planning}
      ...
      - [サイト、ストア、ストアビューの設定](best-practices/planning/sites-stores-store-views.md)
      - [レポート設定](best-practices/planning/reporting-configuration.md)
      - [クラウド デプロイメントのデータベース設定&#x200B;](best-practices/planning/database-on-cloud.md)
      - [MySQL設定](best-practices/planning/mysql-configuration.md)
      - [Redis/Valkey サービス設定](best-practices/planning/redis-valkey-service-configuration.md)
      - [OPcacheのメモリサイズ](best-practices/planning/opcache-memory-size.md)
      - [リアルパスキャッシュサイズ](best-practices/planning/realpath-cache-size.md)
      - [拡張機能](best-practices/planning/extensions.md)
      - [パートナーの昇格](best-practices/planning/partner-escalation.md)
      - [支払い保管処理](best-practices/planning/payment-processing-storage.md)
   - 開発 {#development}
      ...
      - [Git分岐](best-practices/development/git-branching.md)
      ...
      - [CSSおよびJS ファイルの最適化](best-practices/development/optimize-css-js-files.md)
   ...
   - 保守 {#maintenance}
      ...
      - [バックエンドパフォーマンスの最適化](best-practices/maintenance/backend-performance.md)
      ...
      - [データベースのパフォーマンスの問題を解決する](best-practices/maintenance/resolve-database-performance-issues.md)
      - [セキュリティインシデントへの対応](best-practices/maintenance/respond-to-security-incident.md)
      - [本番サイトでの管理者更新のスケジュール](best-practices/maintenance/scheduling-admin-updates-in-production.md)
