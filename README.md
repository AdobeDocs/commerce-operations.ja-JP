...
Adobe Experience Cloud ソリューションの製品チームのテクニカルライター、プログラムマネージャー、開発者で、技術記事の投稿や作成を担当する仕事がある場合は、`https://github.com/Adobe-Enterprise-Docs`にあるプライベートリポジトリを使用する必要があります。
...
リポジトリ固有のタスクの場合は、関係ファイル形式と設定を含めます
詳細については、[`_jekyll/ReadMe.md`](_jekyll/ReadMe.md)を参照してください。
